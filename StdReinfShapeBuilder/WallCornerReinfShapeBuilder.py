...
def create_stirrup_shape_in_wall1(bottom_line1, top_line1, bottom_line2, top_line2,
                                  shape_props, concrete_cover_props, stirrup_length, end_length):

    """
    Create the stirrup shape in the first wall
    ...
    Parameter:  bottom_line1          Bottom line of the first wall
                ...
                shape_props           Shape properties
                concrete_cover_props  Concrete cover at the sides
                stirrup_length        Length of the stirrup
    ...
    ret,top_line2_hlp = AllplanGeo.Offset(stirrup_length, bottom_line2)
    print("top_line1,top_line2_hlp",top_line1,top_line2_hlp)
    top_line2_hlp.Reverse()
...
def create_link_shape_in_wall2(bottom_line1, top_line1, bottom_line2, top_line2,
                               shape_props, concrete_cover_props, start_length, end_length):
    """
    Create the stirrup shape in the second wall
...
def create_stirrup_shape_in_wall2(bottom_line1, top_line1, bottom_line2, top_line2,
                                  shape_props, concrete_cover_props, stirrup_length, end_length):
    ...
    ret,top_line1_hlp = AllplanGeo.Offset(stirrup_length, bottom_line1)

    top_line1_hlp.Reverse()

    shape_builder = AllplanReinf.ReinforcementShapeBuilder()

    shape_builder.AddSides([(0),
                            (bottom_line2, concrete_cover_props.right),
                            (bottom_line1, concrete_cover_props.bottom),
                            (top_line2, concrete_cover_props.left),
                            (top_line1_hlp, 0),
                            (0) ])
