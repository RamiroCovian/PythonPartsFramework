...
def create_bottom_flange_shape_2(polyline3d, shape_props, concrete_cover_props, side_length):
    """
    Create the bottom flange shape
    ...
    shape_builder.AddPoints([(polyline3d[8], concrete_cover_props.left),
                             (polyline3d[9], concrete_cover_props.left + 2 * shape_props.diameter),
                             (polyline3d[10], concrete_cover_props.left),
                             (polyline3d[11], concrete_cover_props.left),
                             (polyline3d[0], concrete_cover_props.bottom),
                             (polyline3d[1], concrete_cover_props.right),
                             (polyline3d[2], concrete_cover_props.right),
                             (polyline3d[3], concrete_cover_props.right + shape_props.diameter * 2)])
...
def create_top_flange_shape(polyline3d, shape_props, concrete_cover_props):
    ...
    Parameter:  polyline3d              3D polyline of the geometry
                shape_props             Shape properties
                concrete_cover_props    Concrete cover properties: needed left, right, top
    """
...
def create_top_flange_shape_2(polyline3d, shape_props, concrete_cover_props, side_length):
    """
    Create the top flange shape
    ...
    shape_builder.AddPoints([(polyline3d[2], concrete_cover_props.left),
                             (polyline3d[3], concrete_cover_props.right + shape_props.diameter * 2),
                             (polyline3d[4], concrete_cover_props.right),
                             (polyline3d[5], concrete_cover_props.right),
                             (polyline3d[6], concrete_cover_props.top),
                             (polyline3d[7], concrete_cover_props.left),
                             (polyline3d[8], concrete_cover_props.left),
                             (polyline3d[9], concrete_cover_props.left + shape_props.diameter * 2)])
...
def create_web_shape(polyline3d, shape_props, concrete_cover_props, side_length, distance):
    """
    Create the web stirrup
    ...
    shape_builder.AddSides([(polyline3d[6], polyline3d[5], concrete_cover_props.top + distance),
                            (polyline3d[8], polyline3d[9], concrete_cover_props.left),
                            (polyline3d[11], polyline3d[0], concrete_cover_props.bottom),
                            (polyline3d[2], polyline3d[3], concrete_cover_props.right),
                            (polyline3d[6], polyline3d[5], concrete_cover_props.top + distance)])
