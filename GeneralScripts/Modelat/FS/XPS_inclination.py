...
class XPS():
    ...
    def __init__(self, doc: AllplanEleAdapter.DocumentAdapter, z_unique: int, ancho_pld, alto_pld, grosor_xps, z_rotation: int, layer_value_name: int,
                inclination_rotation_angle: int, inclination_selector_axis: int|None):
        """Initialize values
    ...
    def create(self):
        ...
        if self.inclination_rotation_angle != 0:
            # Rotate cuboids
            # Rotate PLD cuboid
            xps_cuboid = self.inclination_rotate_geo_object(xps_cuboid)
