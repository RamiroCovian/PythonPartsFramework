...
class PLD():
    ...
    def __init__(self, doc: AllplanEleAdapter.DocumentAdapter, z_unique: int, ancho_pld, alto_pld, z_rotation: int, type_pld: str, layer_value_name: int, borde_afilado_selector: int|None):
