...
<Element>
  <Script>
    <Name>PythonPartsTraining\CommonPoint.py</Name>
  ...
  <Page>
    ...
    <Text>Capturá por roles (Final crea y exporta). Editá con los botones de abajo. Detección de puntos comunes por clave y/o proximidad.</Text>
    ...
    <!-- NUEVO: clave de usuario para vincular puntos entre caminos -->
    <Parameter>
      <Name>UserPointKey</Name>
      <Text>Clave de punto (opcional)</Text>
      <Value></Value>
    ...
    <!-- ===== NUEVO: Detección de puntos comunes ===== -->
    <Parameter>
    ...
    <Parameter>
      <Name>CommonMatchMode</Name>
      <Text>Detección de comunes</Text>
      <Value>both</Value>
      <AllowedValues>by_key;by_proximity;both</AllowedValues>
      <ValueType>Enumeration</ValueType>
    </Parameter>

    <Parameter>
      <Name>CommonTolMM</Name>
      <Text>Tolerancia (mm) proximidad</Text>
      <Value>5.0</Value>
    ...
    <Parameter>
      <Name>HighlightCommon</Name>
      <Text>Resaltar puntos comunes</Text>
      <Value>False</Value>
      <ValueType>CheckBox</ValueType>
    </Parameter>

    <Parameter>
      <Name>RowDetectCommon</Name>
      <Text>Puntos comunes</Text>
      <ValueType>Row</ValueType>
      <Parameter>
        <Name>DetectCommonNow</Name>
        <Text>Detectar ahora</Text>
