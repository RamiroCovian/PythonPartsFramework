...
<Element>
    <Script>
        <Name>Modelat\Estructura\TD\PY\TD_Conjunt_8_clase_PPTD_Solids.py</Name>
    ...
    <Page>
        ...
        <Parameter>
            ...
            <Text>TISS,Ample,Forat,Orientacio,Posicio,Longitud,Profunditat,Edit,Save,acabatEditar,Separator</Text>
            <Value>[]
            </Value>
            <ValueType>namedtuple(Checkbox,Length,Length,StringComboBox,Length,Length,Length,Checkbox,Checkbox,Checkbox,Separator)</ValueType>
            <ValueList>,,,Esq|Dre|Sup|Inf,,,,,</ValueList>
    ...
    <Page>
        ...
        <Parameter>
            ...
            <Text> desplX,desplXAbs,desplY,desplYAbs,mostrarLiniaVertA,desplLinA,mostrarLiniaVertB,desplLinB,Separator</Text>
            <Value>[]</Value>
            <ValueType>namedtuple(Length,Length,Length,Length,Checkbox,Length,Checkbox,Length,Separator)</ValueType>
            <NamedTuple>
                <TypeName>StirrupList</TypeName>
                <FieldNames>desplX,desplXAbs,desplY,desplYAbs,mostrarLiniaVertA,desplLinA,mostrarLiniaVertB,desplLinB,Separator</FieldNames>
            </NamedTuple>
    ...
    <Page>
        ...
        <Parameter>
            ...
            <Name>ColisVertListToShow</Name>
                <Text>Colis,Orientacio,Posicio,Llargada,Amplada,MostrarTFF,Separator</Text>
                ...
                <MinValue>,,0</MinValue>
                <Visible>True, ColisVertListToShow[$list_row][0] == True, ColisVertListToShow[$list_row][0] == True, ColisVertListToShow[$list_row][0] == True, ColisVertListToShow[$list_row][0] == True, ColisVertListToShow[$list_row][0] == True</Visible>
                <Persistent>Model</Persistent>
            </Parameter>
        </Parameter>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <Text>Forat,Orientacio,Posicio,Llargada,Amplada,Completa,Llargada,Amplada,TFF,Profunditat TFF,Separator</Text>
    ...
    <Page>
        ...
        <Parameter>
            ...
            <Text>Colis,Orientacio,Posicio,Llargada,Amplada,MostrarBox,Separator</Text>
            <Value>[]</Value>
            <ValueType>namedtuple(Checkbox,StringComboBox,Length,Length,Length,Checkbox,Separator)</ValueType>
            <ValueList>,Esq|Dre|Sup|Inf,,,,</ValueList>
            <NamedTuple>
        ...
        <Name>ForatsVertList</Name>
            <Text>Forat,Orientacio,Posicio,Llargada,Amplada,Completa,LlargadaB,AmpladaB,TFF,ProfunditatTFF,Separator</Text>
            <Value>[]</Value>
            <ValueType>namedtuple(Checkbox,StringComboBox,Length,Length,Length,Checkbox,Length,Length,Checkbox,Length,Separator)</ValueType>
            ...
            <Visible>False, False, False,False, False, False,False, False,False,False,False,False</Visible>
            <Persistent>Model</Persistent>
        </Parameter>
        ...
        <Parameter>
            ...
            <Text>Femella,Orientacio,Posicio X,Posicio Y,Separacio_forat_femella, PosFemellaXOri,Separacio</Text>
            <Value>[]</Value>
            <ValueType>namedtuple(Checkbox,StringComboBox,Length,Length,Length,Length,Separator)</ValueType>
            <ValueList>,Esq|Dre|Sup|Inf,,,</ValueList>
            <NamedTuple>
        ...
        <Parameter>
            ...
            <Text>BarraFront,Ample,Altura,Orientacio,Posicio,Longitud,Profunditat,Edit,Save,acabatEditar,Separator</Text>
            <Value>[]
            </Value>
            <ValueType>namedtuple(Checkbox,Length,Length,StringComboBox,Length,Length,Length,Checkbox,Checkbox,Checkbox,Separator)</ValueType>
            <ValueList>,,,Esq|Dre,,,,,,,,</ValueList>
        ...
        <Parameter>
            ...
            <Text>Forat,Orientacio,Posicio,Llargada,Amplada,Completa,Llargada,Amplada,MostrarBox,ProfunditatTFF,Separator</Text>
            <Value>[]</Value>
            <ValueType>namedtuple(Checkbox,StringComboBox,Length,Length,Length,Checkbox,Length,Length,Checkbox,Length,Separator)</ValueType>
            <ValueList>,Esq|Dre|Sup|Inf,,,,,,,,,</ValueList>
            <NamedTuple>
        ...
        <Parameter>
            <Name>ColisAdj</Name>
            <Text>Colis,Orientacio,Posicio,Llargada,Amplada,Mostrar,Separator</Text>
            <Value>[]</Value>
            <ValueType>namedtuple(Checkbox,StringComboBox,Length,Length,Length,Checkbox,Separator)</ValueType>
            <ValueList>,Esq|Dre|Sup|Inf,,,,</ValueList>
            <NamedTuple>
    ...
    <Page>
        ...
        <Parameter>
            ...
            <Text>TIS,Ample,Forat,Orientacio,Posicio,Longitud,Profunditat,Edit,Save,acabatEditar,Separator</Text>
            <Value>[]
            </Value>
            <ValueType>namedtuple(Checkbox,Length,Length,StringComboBox,Length,Length,Length,Checkbox,Checkbox,Checkbox,Separator)</ValueType>
            <ValueList>,,,Esq|Dre|Sup|Inf,,,,,,</ValueList>
