    ...
    if event_id == 1000:
        ...
        if trobatAnt and trobatSeg:
            for nBarraVert in range(0, build_ele.IntegerTDSelector.value):
                if build_ele.listDesplVerticals.value[nBarraVert].desplXAbs < build_ele.listDesplVerticals.value[posBarraSegBalcFines].desplXAbs and build_ele.listDesplVerticals.value[nBarraVert].desplXAbs > build_ele.listDesplVerticals.value[posBarraAntBalcFines].desplXAbs:
                    build_ele.listDesplVerticals.value[nBarraVert] = build_ele.listDesplVerticals.value[nBarraVert]._replace(desplXAbs = build_ele.DistanciaEntreTD.value*nBarraVert)
                    build_ele.dadesTDVert.value[nBarraVert] = build_ele.dadesTDVert.value[nBarraVert]._replace(esProvisional = False)
                    build_ele.dadesTDVert.value[nBarraVert] = build_ele.dadesTDVert.value[nBarraVert]._replace(BarraSuperior = "TD Superior")
                    build_ele.dadesTDVert.value[nBarraVert] = build_ele.dadesTDVert.value[nBarraVert]._replace(BarraInferior = "TD Inferior")
...
def create_element_class(build_ele, doc):
    """
    ...
    if build_ele.SelectorPP.value == 1 and build_ele.SelectorTDH.value == "Mes Tubs...":
    ...
    if (build_ele.SelectorPP.value != 1 and build_ele.SelectorPPAnt.value == 1) or build_ele.SelectorTDH.value != "Mes Tubs..." or nHorInt != build_ele.SelectorTDHTotalAnt.value:
        try:
    ...
    if build_ele.SelectorPP.value == 1 and build_ele.SelectorTDH.value == "TD Inferior":
    ...
    elif build_ele.SelectorPP.value == 1 and build_ele.SelectorTDH.value == "TD Superior":
        ...
        if build_ele.UpdateBalconeraFinestra.value:
            ...
            if nVer != posBarraAntBalcFines:
                ...
                build_ele.dadesTDVert.value[posBarraAntBalcFines] = build_ele.dadesTDVert.value[posBarraAntBalcFines]._replace(esProvisional = False)
            ...
            if nVer != posBarraSegBalcFines:
                ...
                build_ele.dadesTDVert.value[posBarraSegBalcFines] = build_ele.dadesTDVert.value[posBarraSegBalcFines]._replace(esProvisional = False)
                build_ele.listDesplVerticals.value[posBarraSegBalcFines] = build_ele.listDesplVerticals.value[posBarraSegBalcFines]._replace(desplXAbs = build_ele.PosicioXBalconera.value + build_ele.AmpleBalconera.value + 80 )#+ build_ele.dadesTDVert.value[posBarraSegBalcFines].BarraAmple/2)
            else:
                build_ele.MostrarTDVertical.value = True
                build_ele.esProvisional.value =False
            ...
            for barresIntermitges in range(1,build_ele.IntegerTDSelector.value-1):
                if build_ele.listDesplVerticals.value[barresIntermitges].desplXAbs > build_ele.listDesplVerticals.value[posBarraAntBalcFines].desplXAbs and build_ele.listDesplVerticals.value[barresIntermitges].desplXAbs < build_ele.listDesplVerticals.value[posBarraSegBalcFines].desplXAbs:
                    build_ele.dadesTDVert.value[barresIntermitges] = build_ele.dadesTDVert.value[barresIntermitges]._replace(esProvisional = True)
                    if build_ele.SelectorTDHorSupBalc.value == "TD Superior":
                        build_ele.dadesTDVert.value[barresIntermitges] = build_ele.dadesTDVert.value[barresIntermitges]._replace(BarraSuperior = build_ele.SelectorTDHorSupBalc.value)
                        build_ele.dadesTDVert.value[barresIntermitges] = build_ele.dadesTDVert.value[barresIntermitges]._replace(BarraInferior = build_ele.SelectorTDHorInfBalc.value)
                    else:
                        build_ele.dadesTDVert.value[barresIntermitges] = build_ele.dadesTDVert.value[barresIntermitges]._replace(BarraSuperior = "TD Superior")
                        build_ele.dadesTDVert.value[barresIntermitges] = build_ele.dadesTDVert.value[barresIntermitges]._replace(BarraInferior = build_ele.SelectorTDHorSupBalc.value)
                    nItermVal += 1
            ...
            if trobatAnt and trobatSeg:
                ...
                if build_ele.SelectorTDHorInfBalc.value != "TD Inferior" or build_ele.SelectorTDHorSupBalc.value != "TD Superior":
                    for barraNoMostrada in range(posBarraAntBalcFines+1, build_ele.IntegerTDSelector.value-1):
                        if build_ele.listDesplVerticals.value[barraNoMostrada].desplXAbs > build_ele.BarraLlargada.value and nbarraInter < len(nIntermitges):
                            trobat = False
                            posInterior = False
                            for barraInterior in range(0, len(nIntermitges)):
                                if barraNoMostrada == barraInterior :
                                    trobat = True
                            if build_ele.listDesplVerticals.value[nIntermitges[nbarraInter]].desplXAbs > build_ele.listDesplVerticals.value[posBarraAntBalcFines].desplXAbs and build_ele.listDesplVerticals.value[nIntermitges[nbarraInter]].desplXAbs < build_ele.listDesplVerticals.value[posBarraSegBalcFines].desplXAbs :#or (build_ele.listDesplVerticals.value[barraNoMostrada].desplXAbs > build_ele.BarraLlargada.value + build_ele.ExtenderInf.value):
                                posInterior = True

                            if  not trobat and build_ele.SelectorTDHorSupBalc.value != "TD Superior" and build_ele.dadesTDVert.value[barraNoMostrada].esProvisional != True:
                                build_ele.listDesplVerticals.value[barraNoMostrada] = build_ele.listDesplVerticals.value[barraNoMostrada]._replace(desplXAbs = build_ele.listDesplVerticals.value[nIntermitges[nbarraInter]].desplXAbs)
                                nbarraInter += 1

                                build_ele.dadesTDVert.value[barraNoMostrada] = build_ele.dadesTDVert.value[barraNoMostrada]._replace(MostrarTDVertical = True)
                                build_ele.dadesTDVert.value[barraNoMostrada] = build_ele.dadesTDVert.value[barraNoMostrada]._replace(BarraSuperior = build_ele.SelectorTDHorSupBalc.value)
                                build_ele.dadesTDVert.value[barraNoMostrada] = build_ele.dadesTDVert.value[barraNoMostrada]._replace(BarraInferior = build_ele.SelectorTDHorInfBalc.value)
                                build_ele.dadesTDVert.value[barraNoMostrada] = build_ele.dadesTDVert.value[barraNoMostrada]._replace(esProvisional = True)
                    ...
                    for barraNoMostrada in range(ultimaBarraPosicionada, build_ele.IntegerTDSelector.value-1):
                        if build_ele.SelectorTDHorInfBalc.value != "TD Inferior" and nbarraInter < len(nIntermitges):
                            ...
                            if (barraNoMostrada != posBarraAntBalcFines and barraNoMostrada != posBarraSegBalcFines) and not trobat and build_ele.dadesTDVert.value[barraNoMostrada].esProvisional != True:#and build_ele.SelectorTDHorSupBalc.value != "TD Superior":
                                build_ele.listDesplVerticals.value[barraNoMostrada] = build_ele.listDesplVerticals.value[barraNoMostrada]._replace(desplXAbs = build_ele.listDesplVerticals.value[nIntermitges[nbarraInter]].desplXAbs)
                                nbarraInter += 1
                                build_ele.dadesTDVert.value[barraNoMostrada] = build_ele.dadesTDVert.value[barraNoMostrada]._replace(MostrarTDVertical = True)
                                build_ele.dadesTDVert.value[barraNoMostrada] = build_ele.dadesTDVert.value[barraNoMostrada]._replace(BarraSuperior = build_ele.SelectorTDHorInfBalc.value)
                                build_ele.dadesTDVert.value[barraNoMostrada] = build_ele.dadesTDVert.value[barraNoMostrada]._replace(BarraInferior = "TD Inferior")
                                build_ele.dadesTDVert.value[barraNoMostrada] = build_ele.dadesTDVert.value[barraNoMostrada]._replace(esProvisional = True)
            ...
            if trobatAnt and trobatSeg:
                ...
                build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Llargada = build_ele.listDesplVerticals.value[posBarraSegBalcFines].desplXAbs - build_ele.listDesplVerticals.value[posBarraAntBalcFines].desplXAbs - build_ele.dadesTDVert.value[posBarraAntBalcFines].BarraAmple)
                ...
                build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(desplX = build_ele.listDesplVerticals.value[posBarraAntBalcFines].desplXAbs + build_ele.dadesTDVert.value[posBarraAntBalcFines].BarraAmple/2 + build_ele.dadesTDVert.value[0].BarraAmple/2)
                build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(desplY = build_ele.listDesplVerticals.value[posBarraAntBalcFines].desplYAbs)
            elif not trobatAnt:

                build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Llargada = build_ele.listDesplVerticals.value[posBarraSegBalcFines].desplXAbs - build_ele.listDesplVerticals.value[0].desplXAbs - build_ele.dadesTDVert.value[0].BarraAmple)
                if build_ele.SelectorTDHorSupBalc.value != "EN Superior" and build_ele.SelectorTDHorSupBalc.value != "EN Inferior":
                    build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Altura = build_ele.BarresHorList.value[nHorSup].Posicio - build_ele.dadesTDHortInter.value[nHorSup].Altura/2)
                else:
                    build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Altura = build_ele.desplZS.value + build_ele.BarraAlturaInf.value - build_ele.BarraAlturaSup.value/2)

                build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(desplX = build_ele.listDesplVerticals.value[0].desplXAbs + build_ele.dadesTDVert.value[0].BarraAmple)
                build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(desplY = build_ele.listDesplVerticals.value[0].desplYAbs)

            elif not trobatSeg:

                build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Llargada = build_ele.listDesplVerticals.value[len(IntegerTDSelector)-1].desplXAbs - build_ele.listDesplVerticals.value[posBarraAntBalcFines].desplXAbs - build_ele.dadesTDVert.value[posBarraAntBalcFines].BarraAmple)
                if build_ele.SelectorTDHorSupBalc.value != "EN Superior" and build_ele.SelectorTDHorSupBalc.value != "EN Inferior":
                    build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Altura = build_ele.BarresHorList.value[nHorSup].Posicio - build_ele.dadesTDHortInter.value[nHorSup].Altura/2)
                else:
                    build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Altura = build_ele.desplZS.value + build_ele.BarraAlturaInf.value - build_ele.BarraAlturaSup.value/2)
                ...
                build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Llargada = build_ele.listDesplVerticals.value[len(IntegerTDSelector)-1].desplXAbs - build_ele.listDesplVerticals.value[0].desplXAbs - build_ele.dadesTDVert.value[0].BarraAmple)
                if build_ele.SelectorTDHorSupBalc.value != "EN Superior" and build_ele.SelectorTDHorSupBalc.value != "EN Inferior":
                    build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Altura = build_ele.BarresHorList.value[nHorSup].Posicio - build_ele.dadesTDHortInter.value[nHorSup].Altura/2)
                else:
                    build_ele.dadesTDInclinades.value[nIncl] = build_ele.dadesTDInclinades.value[nIncl]._replace(Altura = build_ele.desplZS.value + build_ele.BarraAlturaInf.value - build_ele.BarraAlturaSup.value/2)
    ...
    if build_ele.SelectorTDVAnt.value != nVer or (build_ele.SelectorPPAnt.value != build_ele.SelectorPP.value and build_ele.SelectorPP.value == 2):
        mostrar_valors_actuals(build_ele, nVer)
    ...
    #chair = PP_TD_Vertical(random.random() * 3600, build_ele.dadesTDVert.value[0].BarraAmple+10, build_ele.dadesTDVert.value[0].BarraAltura, build_ele.BarraLlargadaVert.value,build_ele.dadesTDVert.value[0].Gruix,
    ...
    if not build_ele.ReduirTempsCarrega.value:
        ...
        if (build_ele.EncaixHorInf.value and build_ele.desplYI.value > 0.0):
            ...
            if build_ele.invertirEncaixInf.value:
                ...
                for i in range(0,len(build_ele.listDesplVerticals.value)):
                    ...
                    if build_ele.dadesTDVert.value[i].EncaixInf:
                        ...
                        matrixOr.append("Inf")
                trans_list = horitzontalPP.create_PP_positions_femelles(listAmples, listAltures, matrixPosX, matrixPosY, matrixMostrarInf, offsetXI, matrixOr, build_ele.Ample_forat_femellaVert.value, build_ele.BarraLlargada.value, build_ele.desplYI.value,[], build_ele.desplXI.value)
            else:
                for i in range(0,len(build_ele.listDesplVerticals.value)):
                ...
                trans_list = horitzontalPP.create_PP_positions_encaix(listAmples2, matrixPosX, matrixPosY, matrixcentrar, matrixMostrar, matrixOffsetY, offsetXI, 'Sup', build_ele.BarraLlargada.value)
            ...
            if build_ele.invertirEncaixInf.value:
                ...
                trans_list = horitzontalPP.create_PP_positions_encaix(listAmples2, matrixPosX, matrixPosY, matrixcentrar,  matrixMostrar, matrixOffsetY, offsetXI, 'Inf', build_ele.BarraLlargada.value )
                horitzontalPP.set_false_femelles()
        else:
            horitzontalPP.set_false_encaix()
        ...
        if build_ele.EncaixHorSup.value and desplYS > 0.0:
            if build_ele.invertirEncaixSup.value:
                ...
                for i in range(0,len(build_ele.listDesplVerticals.value)):
                    matrixOffsetY.append(  build_ele.listDesplVerticals.value[i].desplY + build_ele.dadesTDVert.value[i].BarraAltura - desplYS)#build_ele.dadesTDVert.value[i].BarraAltura
                if (build_ele.MostrarFemellesSup.value and build_ele.SelectorTDHSup.value == "L") or build_ele.SelectorTDHSup.value != "L":
            ...
            if build_ele.invertirEncaixSup.value:
                ...
                for i in range(0,len(build_ele.listDesplVerticals.value)):
                    matrixOffsetY.append(build_ele.BarraAmpleSup.value + desplYS + build_ele.listDesplVerticals.value[i].desplY )
                if (build_ele.MostrarFemellesSup.value and build_ele.SelectorTDHSup.value == "L") or build_ele.SelectorTDHSup.value != "L":
    ...
    #horitzontalPPOBject = PP_TD_Horitzontal(random.random() * 3600,0, build_ele.BarraAmpleInf.value, build_ele.BarraAlturaInf.value+10, build_ele.BarraLlargada.value, 0,#DistanciaEntreTD, BarraAmple, BarraAltura,BarraLlargada, BarraGruix,
    ...
    #horitzontalPPOBjectA = PP_TD_Horitzontal(random.random() * 3600,0, build_ele.BarraAmpleInf.value, build_ele.BarraAlturaInf.value+10, build_ele.BarraLlargada.value, 0,#DistanciaEntreTD, BarraAmple, BarraAltura,BarraLlargada, BarraGruix,
    ...
    if build_ele.MostrarTDHoritzontalInf.value :
        ...
        for i in range(0, len(build_ele.ColisParINF.value)):
            if build_ele.ColisParINF.value[i].Colis and build_ele.ColisParINF.value[i].MostrarBox and build_ele.ColisParINF.value[i].Posicio < build_ele.BarraLlargada.value + build_ele.ExtenderInf.value:
        ...
        for i in range(0, len(build_ele.PotaParINF.value)):
            #if build_ele.PotaParINF.value[i].Forat and build_ele.ForatsParINF.value[i].orientacio  == "Inf" and build_ele.ForatsParINF.value[i].Posicio < build_ele.BarraLlargada.value + build_ele.ExtenderInf.value:
            if build_ele.PotaParINF.value[i].Pota and build_ele.PotaParINF.value[i].Posicio < build_ele.BarraLlargada.value + build_ele.ExtenderInf.value:
        ...
        if build_ele.SepararTDHoritzontalInf.value:
            ...
            if build_ele.mostrarLiniaIntInf1.value:
                ...
                linia = build_ele.SelectorLiniaInf.value[len(build_ele.SelectorLiniaInf.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.BarraAmpleInf.value, build_ele.BarraLlargada.value + build_ele.ExtenderInf.value, True, pointUbi, int(linia), build_ele.SelectorLayerInf.value)
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
                    group_elems_preview.append(polyhedronCentral[0])
                    group_elems.append(polyhedronCentral[3])
            ...
            if build_ele.mostrarLiniaIntInf2.value:
                ...
                linia = build_ele.SelectorLiniaInf.value[len(build_ele.SelectorLiniaInf.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.BarraAmpleInf.value, build_ele.BarraLlargada.value, True, pointUbi, int(linia), build_ele.SelectorLayerInf.value)
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
                    group_elems_preview.append(polyhedronCentral[0])
                    group_elems.append(polyhedronCentral[3])
    ...
    if build_ele.MostrarTDHoritzontalSup.value:
        ...
        if build_ele.SepararTDHoritzontalSup.value:
            if build_ele.listDesplHoritzontalsSup.value[0].mostrarLiniaA:
                punt_central = desplXSeparatSup + build_ele.listDesplHoritzontalsSup.value[0].desplX + build_ele.listDesplHoritzontalsSup.value[0].BarraAlturaSup/2
            ...
            if build_ele.listDesplHoritzontalsSup.value[0].mostrarLiniaB:
                punt_central = desplXSeparatSup + build_ele.listDesplHoritzontalsSup.value[0].desplX + build_ele.listDesplHoritzontalsSup.value[0].BarraAlturaSup/2
                pointUbi = AllplanGeo.Point3D(desplXSeparatSup, vectorH2[13] + build_ele.listDesplHoritzontalsSup.value[0].BarraAmpleSup/2 + build_ele.listDesplHoritzontalsSup.value[0].desplLinB, vectorH2[14] +  build_ele.listDesplHoritzontalsSup.value[0].BarraAlturaSup/2)
                linia = build_ele.SelectorLiniaSup.value[len(build_ele.SelectorLiniaSup.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central,build_ele.listDesplHoritzontalsSup.value[0].BarraAmpleSup,build_ele.listDesplHoritzontalsSup.value[0].BarraLlargadaSup, True, pointUbi, int(linia), build_ele.SelectorLayerSup.value)
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
        ...
        try:
            ...
            for matrix in trans_list:
                ...
                if build_ele.dadesTDVert.value[j].esProvisional:
                    ...
                    #if build_ele.dadesTDVert.value[j].BarraInferior == "TD Inferior":
                ...
                for nForat in range(0,len(Forats)):
                    if Forats[nForat].Forat and build_ele.dadesTDVert.value[j].MostrarTDVertical and build_ele.listDesplVerticals.value[j].desplXAbs <= build_ele.BarraLlargada.value + build_ele.ExtenderInf.value:#and Forats[nForat].MostrarBox
                ...
                if not mostrarInterior:
                    if build_ele.DistanciaEntreTDAnt.value != build_ele.DistanciaEntreTD.value :
                    ...
                    elif build_ele.BarraLlargadaAnt.value != build_ele.BarraLlargada.value and j != len(trans_list)-1 and build_ele.listDesplVerticals.value[j].desplXAbs == 0 and j != 0 :
                        ...
                        if j == nVer and build_ele.SelectorPP.value == 2 and build_ele.SelectorPPAnt.value == 2:
                            #si no esta mostrat
                        ...
                        if j == nVer and build_ele.SelectorPP.value == 2 and build_ele.SelectorPPAnt.value != 2:
                            ...
                            build_ele.desplXVertAbs.value = build_ele.listDesplVerticals.value[j].desplXAbs
                            build_ele.desplYVertAbs.value = build_ele.listDesplVerticals.value[j].desplYAbs
                            build_ele.listDesplVerticals.value[j] = build_ele.listDesplVerticals.value[j]._replace(desplXAbs = build_ele.listDesplVerticals.value[j].desplXAbs)
                            build_ele.listDesplVerticals.value[j] = build_ele.listDesplVerticals.value[j]._replace(desplYAbs = build_ele.listDesplVerticals.value[j].desplYAbs)
                        else:
                            if j == 0 :#and build_ele.listDesplVerticals.value[j].desplXAbs == 0:
                                ...
                                build_ele.listDesplVerticals.value[j] = build_ele.listDesplVerticals.value[j]._replace(desplY = build_ele.listDesplVerticals.value[j].desplYAbs)
                            else:
                                if j == nVer and build_ele.SelectorPP.value == 2 and build_ele.SelectorPPAnt.value != 2:
                                    build_ele.listDesplVerticals.value[j] = build_ele.listDesplVerticals.value[j]._replace(desplXAbs = build_ele.desplXVertAbs.value)
                                    build_ele.listDesplVerticals.value[j] = build_ele.listDesplVerticals.value[j]._replace(desplYAbs = build_ele.desplYVertAbs.value)
                    ...
                    if j == len(trans_list)-1:
                        build_ele.listDesplVerticals.value[j] = build_ele.listDesplVerticals.value[j]._replace(desplXAbs = build_ele.BarraLlargada.value - build_ele.dadesTDVert.value[j].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2)
                        build_ele.listDesplVerticals.value[j] = build_ele.listDesplVerticals.value[j]._replace(desplX = 0)
                ...
                posHorInfAux = 0
                alturaInf = 0
                if build_ele.dadesTDVert.value[j].BarraInferior != "TD Inferior" and build_ele.dadesTDVert.value[j].BarraInferior != "TD Superior":
                    nHorInf = build_ele.dadesTDVert.value[j].BarraInferior
                    if len(build_ele.dadesTDVert.value[j].BarraInferior) > 3:
                        if len(build_ele.dadesTDVert.value[j].BarraInferior) == 7:
                            nHorInfCentenes = int(build_ele.dadesTDVert.value[j].BarraInferior[-3])
                            nHorInfDecenes = int(build_ele.dadesTDVert.value[j].BarraInferior[-2])
                            nHorInfUnitats = int(build_ele.dadesTDVert.value[j].BarraInferior[-1])
                            nHorInf = nHorInfCentenes*100 + nHorInfDecenes*10 + nHorInfUnitats
                        elif len(build_ele.dadesTDVert.value[j].BarraInferior) == 6:
                            nHorInfDecenes = int(build_ele.dadesTDVert.value[j].BarraInferior[-2])
                            nHorInfUnitats = int(build_ele.dadesTDVert.value[j].BarraInferior[-1])
                            nHorInf = nHorInfDecenes*10 + nHorInfUnitats
                        elif len(build_ele.dadesTDVert.value[j].BarraInferior) == 5:
                            nHorInf = int(build_ele.dadesTDVert.value[j].BarraInferior[-1])
                        #tubVert = build_ele.dadesTDVert.value[j].BarraInferior[-3]
                        #tubHor = build_ele.dadesTDVert.value[j].BarraInferior[-1]
                ...
                for nBarraInfEnc in range(0,build_ele.nBarresTDHoritzontalInf.value):
                    ...
                    if not trobatInf and build_ele.SepararTDHoritzontalInf.value and build_ele.listDesplVerticals.value[j].desplXAbs + build_ele.dadesTDVert.value[j].BarraAmple >= build_ele.listDesplHoritzontalsInf.value[nBarraInfEnc].desplX and build_ele.listDesplVerticals.value[j].desplXAbs - build_ele.dadesTDVert.value[j].BarraAmple  <=  build_ele.listDesplHoritzontalsInf.value[nBarraInfEnc].desplX + build_ele.listDesplHoritzontalsInf.value[nBarraInfEnc].BarraLlargadaInf:
                ...
                if build_ele.dadesTDVert.value[j].LlargadaAut:
                    ...
                    if build_ele.dadesTDVert.value[j].BarraInferior != "TD Inferior" or build_ele.dadesTDVert.value[j].BarraSuperior != "TD Superior":
                        if build_ele.dadesTDVert.value[j].BarraInferior != "TD Inferior":
                            if len(build_ele.dadesTDVert.value[j].BarraInferior) > 3:
                                if len(build_ele.dadesTDVert.value[j].BarraInferior) == 7:
                                    nHorInfCentenes = int(build_ele.dadesTDVert.value[j].BarraInferior[-3])
                        ...
                        if build_ele.dadesTDVert.value[j].BarraSuperior != "TD Superior":
                            if len(build_ele.dadesTDVert.value[j].BarraSuperior) > 3:
                                if len(build_ele.dadesTDVert.value[j].BarraSuperior) == 7:
                                    nHorSupCentenes = int(build_ele.dadesTDVert.value[j].BarraSuperior[-3])
                                    nHorSupDecenes = int(build_ele.dadesTDVert.value[j].BarraSuperior[-2])
                                    nHorSupUnitats = int(build_ele.dadesTDVert.value[j].BarraSuperior[-1])
                                    nHorSup = nHorSupCentenes*100 + nHorSupDecenes*10 + nHorSupUnitats
                                elif len(build_ele.dadesTDVert.value[j].BarraSuperior) == 6:
                                    nHorSupDecenes = int(build_ele.dadesTDVert.value[j].BarraSuperior[-2])
                                    nHorSupUnitats = int(build_ele.dadesTDVert.value[j].BarraSuperior[-1])
                                    nHorSup = nHorSupDecenes*10 + nHorSupUnitats
                                elif len(build_ele.dadesTDVert.value[j].BarraSuperior) == 5:
                                    nHorSup = int(build_ele.dadesTDVert.value[j].BarraSuperior[-1])
                                #tubVert = build_ele.dadesTDVert.value[j].BarraSuperior[-3]
                                #tubHor = build_ele.dadesTDVert.value[j].BarraSuperior[-1]
                            ...
                            if not build_ele.dadesTDVert.value[j].EncaixSup:
                                posHorSup = vectorH2[14]-posHorInf + build_ele.BarraAlturaSup.value
                            else:
                                posHorSup = vectorH2[14]-posHorInf

                        #if build_ele.dadesTDVert.value[j].EncaixInf and build_ele.dadesTDVert.value[j].EncaixSup:
                        #    posHorSup -= build_ele.dadesTDHortInter.value[nHorSup].Altura/2 - build_ele.dadesTDHortInter.value[nHorInf].Altura/2

                        if build_ele.dadesTDVert.value[j].BarraInferior == "TD Inferior" and build_ele.dadesTDVert.value[j].BarraSuperior != "TD Superior" and not build_ele.dadesTDVert.value[j].EncaixSup and build_ele.dadesTDVert.value[j].EncaixInf:
                            posHorSup -= 1

                    else:
                        posHorSup = vectorH2[14]
                        if not build_ele.dadesTDVert.value[j].EncaixSup:
                    ...
                    if not trobatInf and build_ele.SepararTDHoritzontalInf.value and build_ele.dadesTDVert.value[j].EncaixInf:
                ...
                if build_ele.dadesTDVert.value[j].FounColor== 0:
                    build_ele.dadesTDVert.value[j]= build_ele.dadesTDVert.value[j]._replace(FounColor = 1)

                TDV_Int = PP_TD_Vertical(random.random() * 3600, build_ele.dadesTDVert.value[j].BarraAmple, build_ele.dadesTDVert.value[j].BarraAltura, BarrallargadaVert,build_ele.dadesTDVert.value[j].Gruix,
                                            #build_ele.IsUseGlobalPropVert.value, build_ele.FounColorVert.value, build_ele.BarraLayerVert.value,
                                            build_ele.IsUseGlobalPropVert.value, build_ele.dadesTDVert.value[j].FounColor, build_ele.BarraLayerVert.value,
                                            Colis, Potes, Forats, #matrius -------------------------------
                ...
                colorCavitat = getColorCavitat(build_ele.dadesTDVert.value[j].BarraAltura)
                common_propsObjectVert.Color = colorCavitat
                common_propsObjectVert2.Color = colorCavitat
                verticalPPOBject5 = PP_TD_Vertical(random.random() * 3600,build_ele.dadesTDVert.value[j].BarraAmple +10 , build_ele.dadesTDVert.value[j].BarraAltura, BarrallargadaVert + 10,0,
                                        ...
                                        False, False,
                                        [])
                verticalPPOBject5A = PP_TD_Vertical(random.random() * 3600,build_ele.dadesTDVert.value[j].BarraAmple +10 , build_ele.dadesTDVert.value[j].BarraAltura, BarrallargadaVert + 10 ,0,
                ...
                if  j < len(build_ele.nListBarresHor.value):
                    ...
                    for nbarraHorAnterior in range(0,len(build_ele.BarresHorList.value)-1):
                        ...
                        if NBarraFinal == j:
                            ...
                            offsetYAnt.append(build_ele.dadesTDHortInter.value[nbarraHorAnterior].Ample/2 - build_ele.dadesTDVert.value[NBarraInici].Ample_forat_femellaVert/2 + build_ele.dadesTDHortInter.value[nbarraHorAnterior].desplY - build_ele.listDesplVerticals.value[NBarraFinal].desplYAbs)



                        if NBarraInici == j:
                            posInf = build_ele.BarraAlturaInf.value
                            if build_ele.dadesTDVert.value[NBarraInici].BarraInferior != "TD Inferior":
                                posInf = build_ele.BarresHorList.value[nHorInf].Posicio + build_ele.dadesTDHortInter.value[nHorInf].Altura/2 - 1
                                if  not build_ele.dadesTDVert.value[NBarraInici].EncaixInf:
                                    posInf = build_ele.BarresHorList.value[nHorInf].Posicio - build_ele.dadesTDHortInter.value[nHorInf].Altura/2
                            else:
                                if  not build_ele.dadesTDVert.value[NBarraInici].EncaixInf:
                                    posInf =  0
                            if not build_ele.EncaixHorInf.value or build_ele.dadesTDVert.value[NBarraInici].EncaixInf:
                            ...
                            offsetY.append(build_ele.dadesTDHortInter.value[nbarraHorAnterior].Ample/2 - build_ele.dadesTDVert.value[NBarraInici].Ample_forat_femellaVert/2 + build_ele.dadesTDHortInter.value[nbarraHorAnterior].desplY - build_ele.listDesplVerticals.value[NBarraInici].desplYAbs)
                ...
                FemellesAux = TDV_Int.actualitzar_femelles_TDH(listFemellesAnt, listFemellesAct, j, offsetY, offsetYAnt, crearFemellesxEncaixInf and build_ele.dadesTDVert.value[j].BarraInferior == "TD Inferior", desplInf, crearFemellesxEncaixSup and build_ele.dadesTDVert.value[j].BarraSuperior == "TD Superior", desplSup, separacioFemellaInf , separacioFemellaSup, separacioFemellaInt)
                    ...
                    if  j < len(build_ele.nListBarresHor.value):
                        ...
                        for posBarraHor in range(inici, final):#recorrer totes les Barres Horitzontals de cada vertical
                            ...
                            if NBarraInici < len(trans_list)  and build_ele.BarresHorList.value[posBarraHor].BarraHor:
                                if NBarraFinal+1 < len(trans_list):
                                    if not build_ele.BarresHorList.value[posBarraHor].AutoLongitud:
                                        ...
                                        if build_ele.dadesTDVert.value[NBarraFinal].MostrarTDVertical :#and not build_ele.BarresVertList.value[j*NombreBarresVertInt].BarraVert:
                                            llargada = build_ele.listDesplVerticals.value[NBarraFinal].desplXAbs - build_ele.dadesTDVert.value[NBarraFinal].BarraAmple/2 - build_ele.listDesplVerticals.value[NBarraInici].desplXAbs - build_ele.dadesTDVert.value[NBarraInici].BarraAmple/2 - build_ele.dadesTDHortInter.value[posBarraHor].desplX
                                ...
                                for nBarraVertical in range(0, len(build_ele.dadesTDVert.value)-1):
                                    if build_ele.dadesTDVert.value[nBarraVertical].BarraInferior == "Tub " +str(posBarraHor):#Numeracio malament #+ str(j*(posBarraHor - inici)):
                                        ...
                                        pos = build_ele.listDesplVerticals.value[nBarraVertical].desplXAbs - (build_ele.listDesplVerticals.value[NBarraInici].desplXAbs + build_ele.dadesTDVert.value[NBarraInici].BarraAmple/2) - build_ele.dadesTDVert.value[nBarraVertical].BarraAmple/2 -0.5 - build_ele.dadesTDHortInter.value[posBarraHor].desplX
                                        ...
                                        posFemellaY = desplY - desplYInf + build_ele.dadesTDVert.value[nBarraVertical].BarraAltura/2 - 7.5
                                    ...
                                    if build_ele.dadesTDVert.value[nBarraVertical].BarraSuperior == "Tub " + str(posBarraHor): #+ str(j*(posBarraHor - inici)):
                                        ...
                                        posFemellaY = desplY - desplYSup + build_ele.dadesTDVert.value[nBarraVertical].BarraAltura/2 - 7.5
                                ...
                                if build_ele.BarresHorList.value[posBarraHor].Orientacio == 'Inf' and not build_ele.BarresHorList.value[posBarraHor].AutoLongitud :
                                    ...
                                    matrix_Aux.SetValue(12, build_ele.dadesTDHortInter.value[posBarraHor].desplX + posInici - build_ele.dadesTDVert.value[NBarraInici].BarraAmple/2 + build_ele.dadesTDVert.value[0].BarraAmple/2 - build_ele.dadesTDVert.value[NBarraInici].Gruix + 2 - llargada)#- build_ele.dadesTDHortInter.value[posBarraHor].desplX)
                                else:
                                    ...
                                    matrix_Aux.SetValue(12, build_ele.dadesTDHortInter.value[posBarraHor].desplX + posInici + build_ele.dadesTDVert.value[NBarraInici].BarraAmple/2 + build_ele.dadesTDVert.value[0].BarraAmple/2 - build_ele.dadesTDVert.value[NBarraInici].Gruix + 2 )#- build_ele.dadesTDHortInter.value[posBarraHor].desplX)
                                ...
                                if matrix_Aux[12]< build_ele.BarraLlargada.value + build_ele.ExtenderInf.value:
                ...
                try:
                    ...
                    for barraFrontal in range(inici, inici+final):
                        ...
                        if build_ele.BarresFrontList.value[barraFrontal].BarraFront:
                            ...
                            matrix_Front.SetValue(12, matrix[12])
                            matrix_Front.SetValue(13, matrix[13])
                            ...
                            if build_ele.BarresFrontList.value[barraFrontal].Orientacio == 'Esq' :
                                matrix_Front.SetValue(12, build_ele.listDesplVerticals.value[j].desplXAbs + build_ele.dadesTDVert.value[j].BarraAmple/2 +  build_ele.BarresFrontList.value[barraFrontal].Amplitud/2 - (build_ele.dadesTDVert.value[j].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2))#- profunditat
                                matrix_Front.SetValue(13, matrix[13] + build_ele.listDesplVerticals.value[j].desplY + build_ele.dadesTDVert.value[j].BarraAltura - build_ele.BarresFrontList.value[barraFrontal].Profunditat) #- profunditat
                            elif build_ele.BarresFrontList.value[barraFrontal].Orientacio == 'Inf' :
                                matrix_Front.SetValue(12, build_ele.listDesplVerticals.value[j].desplXAbs + build_ele.dadesTDVert.value[j].BarraAmple - build_ele.BarresFrontList.value[barraFrontal].Profunditat - (build_ele.dadesTDVert.value[j].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2)) #- profunditat
                            elif build_ele.BarresFrontList.value[barraFrontal].Orientacio == 'Dre' :
                                matrix_Front.SetValue(12, build_ele.listDesplVerticals.value[j].desplXAbs + build_ele.dadesTDVert.value[j].BarraAmple/2 - build_ele.BarresFrontList.value[barraFrontal].Amplitud/2 - (build_ele.dadesTDVert.value[j].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2))
                                matrix_Front.SetValue(13, matrix[13] + build_ele.BarresFrontList.value[barraFrontal].Profunditat)#- build_ele.BarraAmpleVert.value) #+ profunditat
                            elif build_ele.BarresFrontList.value[barraFrontal].Orientacio == 'Sup' :
                                matrix_Front.SetValue(12, build_ele.listDesplVerticals.value[j].desplXAbs - build_ele.BarresFrontList.value[barraFrontal].Longitud + build_ele.BarresFrontList.value[barraFrontal].Profunditat - (build_ele.dadesTDVert.value[j].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2)) #+ profunditat
                            else:
                                print("no hauria d'entrar aqui")
                            ...
                            if build_ele.listDesplVerticals.value[j].desplXAbs < build_ele.BarraLlargada.value + build_ele.ExtenderInf.value:
                                #if build_ele.dadesTDVert.value[j].MostrarRecess and build_ele.MostrarCavitatsRecess.value:
                                if build_ele.MostrarCavitatsRecess.value:
                                ...
                                #if build_ele.dadesTDVert.value[j].MostrarCavitat and build_ele.MostrarCavitats.value:
                                if build_ele.MostrarCavitats.value:
                    ...
                    if build_ele.desplYI.value < 0 or (build_ele.EncaixHorInf.value and build_ele.desplYI.value <= 0):
                        despl = build_ele.BarraAmpleInf.value + build_ele.desplYI.value - build_ele.listDesplVerticals.value[j].desplYAbs
                        orient = 'Dre'
                    else:
                        despl =  build_ele.dadesTDVert.value[j].BarraAltura - build_ele.desplYI.value + build_ele.listDesplVerticals.value[j].desplYAbs
                        #despl =   build_ele.desplYI.value + build_ele.barraAlturaInf.value - build_ele.listDesplVerticals.value[j].desplY
                        orient = 'Esq'
                    ...
                    if build_ele.dadesTDVert.value[j].BarraInferior != "TD Inferior" and build_ele.dadesTDVert.value[j].BarraInferior != 0:
                        if len(build_ele.dadesTDVert.value[j].BarraInferior) == 7:
                            nHorInfCentenes = int(build_ele.dadesTDVert.value[j].BarraInferior[-3])
                            nHorInfDecenes = int(build_ele.dadesTDVert.value[j].BarraInferior[-2])
                            nHorInfUnitats = int(build_ele.dadesTDVert.value[j].BarraInferior[-1])
                        ...
                        despl = build_ele.dadesTDHortInter.value[nHorInf].Ample +build_ele.dadesTDHortInter.value[nHorInf].desplY - build_ele.listDesplVerticals.value[j].desplYAbs


                        if not build_ele.BarresVertList.value[j].EncaixInf:
                                desplY = build_ele.listDesplVerticals.value[j].desplYAbs
                                desplYInf = build_ele.dadesTDHortInter.value[nHorInf].desplY
                                puntCentralY = build_ele.dadesTDVert.value[j].BarraAltura/2 + desplY
                    ...
                    if build_ele.EncaixHorInf.value and build_ele.invertirEncaixInf.value and not build_ele.dadesTDVert.value[j].EncaixInf:
                        ...
                        bob = TDVertCollection( BarraFront = not build_ele.dadesTDVert.value[j].EncaixInf,
                                                Orientacio = orient,
                        ...
                        if not build_ele.SepararTDHoritzontalInf.value:
                            ...
                            trobatInf = False
                            for nBarraInfEnc in range(0,build_ele.nBarresTDHoritzontalInf.value):
                                if not trobatInf and build_ele.listDesplVerticals.value[j].desplXAbs >= build_ele.listDesplHoritzontalsInf.value[nBarraInfEnc].desplX and build_ele.listDesplVerticals.value[j].desplXAbs <=  build_ele.listDesplHoritzontalsInf.value[nBarraInfEnc].desplX + build_ele.listDesplHoritzontalsInf.value[nBarraInfEnc].BarraLlargadaInf:
                                    encaixosAux.append(bob)
                                    trobatInf = True


                    if build_ele.desplYS.value <= 0 and build_ele.EncaixHorSup.value:
                        despl = build_ele.BarraAmpleSup.value + build_ele.desplYS.value - build_ele.listDesplVerticals.value[j].desplY
                        orient = 'Dre'
                    else:
                        if (build_ele.EncaixHorSup.value):
                            despl =  build_ele.dadesTDVert.value[j].BarraAltura - build_ele.desplYS.value + build_ele.listDesplVerticals.value[j].desplYAbs
                            orient = 'Esq'
                    ...
                    if build_ele.dadesTDVert.value[j].BarraSuperior != "TD Superior":
                        ...
                        despl = build_ele.dadesTDHortInter.value[nHorSup].Ample +build_ele.dadesTDHortInter.value[nHorSup].desplY - build_ele.listDesplVerticals.value[j].desplYAbs
                        ...
                        if not build_ele.BarresVertList.value[j].EncaixSup:
                                ...
                                if (puntCentralY > puntCentralYSup) :
                                    ...
                                    orient = "Esq"
                                    despl = (build_ele.dadesTDVert.value[j].BarraAltura + build_ele.listDesplVerticals.value[j].desplYAbs) - build_ele.dadesTDHortInter.value[nHorSup].desplY



                    if build_ele.EncaixHorSup.value and build_ele.invertirEncaixSup.value :
                        TDVertCollection = collections.namedtuple('StirrupList', 'BarraFront Orientacio Posicio Longitud Amplitud Profunditat Edit acabatEditar')
                        bob = TDVertCollection( BarraFront = not build_ele.dadesTDVert.value[j].EncaixSup,
                                                Orientacio = orient,
                                                Longitud = LongitudSup,
                                                Amplitud = build_ele.dadesTDVert.value[j].BarraAmple,
                                                #Posicio = build_ele.BarraLlargadaVert.value - LongitudSup /2,
                                                Posicio = build_ele.dadesTDVert.value[j].BarraAlcada - LongitudSup /2,
                                                Profunditat = despl ,#+ ,#10.0, #calcular prof matrixOffsetY???
                                                Edit = False,
                                                acabatEditar = False)
                        encaixosAux.append(bob)
                    ...
                    if matrixMostrar[j] and matrix0[12]< build_ele.BarraLlargada.value + build_ele.ExtenderInf.value:
                        ...
                        if build_ele.dadesTDVert.value[j].esProvisional:
                            ...
                            if build_ele.dadesTDVert.value[j].BarraInferior != "TD Inferior":
                                ...
                                if j == 0 or build_ele.listDesplVerticals.value[j].desplXAbs == build_ele.listDesplVerticals.value[0].desplXAbs:
                                    esExtrem = True
                                    esFinal = False
                                    numsRetornar = [1,3]#finalDre
                                if j == build_ele.IntegerTDSelector.value-1 or build_ele.listDesplVerticals.value[build_ele.IntegerTDSelector.value-1].desplXAbs == build_ele.listDesplVerticals.value[j].desplXAbs:
                                    esExtrem = True
                                    esFinal = True
                                    numsRetornar = [0,2]#finalEsq

                                if build_ele.dadesTDVert.value[j].esExtrem:
                                    esExtrem = True
                                    if build_ele.listDesplVerticals.value[j].desplXAbs < build_ele.BarraLlargada.value/2:
                                        esFinal = False
                                        numsRetornar = [1,3]#finalDre
                                    else:
                                        esFinal = True
                        ...
                        if build_ele.listDesplVerticals.value[j].mostrarLiniaVertA:
                            ...
                            if len(build_ele.dadesTDVert.value[j].linia)< 6  or build_ele.dadesTDVert.value[j].linia == '':
                            ...
                            if len(build_ele.dadesTDVert.value[j].layer) == 0:
                                build_ele.dadesTDVert.value[j] = build_ele.dadesTDVert.value[j]._replace(layer = "TD_FIXACIO")
    ...
    try:
        ...
        for posBarraRef in range(inici, final):#recorrer totes les Barres Reforcs de cada vertical
            ...
            BarraIniciRef = 0
            BarraFinalRef = 1
            if len(build_ele.BarresRefList.value[posBarraRef].BarraIni) > 3:
                if len(build_ele.BarresRefList.value[posBarraRef].BarraIni) == 7:
                    nHorInfCentenes = int(build_ele.BarresRefList.value[posBarraRef].BarraIni[-3])
                    nHorInfDecenes = int(build_ele.BarresRefList.value[posBarraRef].BarraIni[-2])
                    nHorInfUnitats = int(build_ele.BarresRefList.value[posBarraRef].BarraIni[-1])
                    BarraIniciRef = nHorInfCentenes*100 + nHorInfDecenes*10 + nHorInfUnitats
                elif len(build_ele.BarresRefList.value[posBarraRef].BarraIni) == 6:
                    nHorInfDecenes = int(build_ele.BarresRefList.value[posBarraRef].BarraIni[-2])
                    nHorInfUnitats = int(build_ele.BarresRefList.value[posBarraRef].BarraIni[-1])
                    BarraIniciRef = nHorInfDecenes*10 + nHorInfUnitats
                elif len(build_ele.BarresRefList.value[posBarraRef].BarraIni) == 5:
                    BarraIniciRef = int(build_ele.BarresRefList.value[posBarraRef].BarraIni[-1])

            if len(build_ele.BarresRefList.value[posBarraRef].BarraFin) > 3:
                if len(build_ele.BarresRefList.value[posBarraRef].BarraFin) == 7:
                    nHorInfCentenes = int(build_ele.BarresRefList.value[posBarraRef].BarraFin[-3])
                    nHorInfDecenes = int(build_ele.BarresRefList.value[posBarraRef].BarraFin[-2])
                    nHorInfUnitats = int(build_ele.BarresRefList.value[posBarraRef].BarraFin[-1])
                    BarraFinalRef = nHorInfCentenes*100 + nHorInfDecenes*10 + nHorInfUnitats
                elif len(build_ele.BarresRefList.value[posBarraRef].BarraFin) == 6:
                    nHorInfDecenes = int(build_ele.BarresRefList.value[posBarraRef].BarraFin[-2])
                    nHorInfUnitats = int(build_ele.BarresRefList.value[posBarraRef].BarraFin[-1])
                    BarraFinalRef = nHorInfDecenes*10 + nHorInfUnitats
                elif len(build_ele.BarresRefList.value[posBarraRef].BarraFin) == 5:
                    BarraFinalRef = int(build_ele.BarresRefList.value[posBarraRef].BarraFin[-1])
            ...
            if build_ele.BarresRefList.value[posBarraRef].BarraRef:
                ...
                if build_ele.BarresRefList.value[posBarraRef].AutoLongitud:
                    if build_ele.listDesplVerticals.value[BarraFinalRef].desplXAbs -(build_ele.listDesplVerticals.value[BarraIniciRef].desplXAbs + build_ele.dadesTDVert.value[BarraIniciRef].BarraAmple) > 0:
                        llargada = build_ele.listDesplVerticals.value[BarraFinalRef].desplXAbs - build_ele.dadesTDVert.value[BarraFinalRef].BarraAmple/2 -(build_ele.listDesplVerticals.value[BarraIniciRef].desplXAbs + build_ele.dadesTDVert.value[BarraIniciRef].BarraAmple/2 )- build_ele.dadesENReftInter.value[posBarraRef].desplX
                    else:
                ...
                reforcRef = PP_TD_Horitzontal_reforc(random.random() * 3600, build_ele.dadesENReftInter.value[posBarraRef].Ample, build_ele.dadesENReftInter.value[posBarraRef].Altura,llargada-5 , build_ele.dadesENReftInter.value[posBarraRef].Gruix, False,# (ENV BarraLlargada), BarraAmple, BarraAltura,BarraLlargada( ), BarraGruix,
                                    build_ele.dadesENReftInter.value[posBarraRef].IsUseGlobalProp, build_ele.dadesENReftInter.value[posBarraRef].FounColor, build_ele.dadesENReftInter.value[posBarraRef].BarraLayer,# IsUseGlobalPropVert, FounColorVert, BarraLayerVert,
                                    encaixos) #EncaixosPar))
                ...
                if  mostrarActual == "TDR"+str(nRef) and build_ele.BarresRefList.value[posBarraRef].BarraRef and nRef == posBarraRef :
                ...
                colorCavitat = getColorCavitat(build_ele.dadesENReftInter.value[posBarraRef].Ample)
                ...
                '''
                ReforcPPOBjectR = PP_TD_Horitzontal_reforc(random.random() * 3600, build_ele.dadesENReftInter.value[posBarraRef].Ample, build_ele.dadesENReftInter.value[posBarraRef].Altura+10,llargada, build_ele.dadesENReftInter.value[posBarraRef].Gruix,False,# , BarraAmple, BarraAltura,BarraLlargada, BarraGruix,
                                        False, common_propsObject.Color, common_propsObject.Layer,# IsUseGlobalPropVert, FounColorVert, BarraLayerVert,
                                        [])
                '''

                ReforcPPOBjectR = PP_TD_Horitzontal(random.random() * 3600,0, build_ele.dadesENReftInter.value[posBarraRef].Ample, build_ele.dadesENReftInter.value[posBarraRef].Altura+10, llargada, 0,#DistanciaEntreTD, BarraAmple, BarraAltura,BarraLlargada, BarraGruix,
                                False, common_propsObject.Color, common_propsObject.Layer,# IsUseGlobalPropVert, FounColorVert, BarraLayerVert,
                                [], [], [],#ColisPar, PotaPar, #matrius
                                0, 0, 0,#Ample_forat_femella, Altura_forat_femella, Separacio_forat_femella,
                                [], #Femelles, #matriu
                ...
                ReforcPPOBjectR2 = PP_TD_Horitzontal(random.random() * 3600,0, build_ele.dadesENReftInter.value[posBarraRef].Ample, build_ele.dadesENReftInter.value[posBarraRef].Altura+10, llargada, 0,#DistanciaEntreTD, BarraAmple, BarraAltura,BarraLlargada, BarraGruix,
                ...
                if build_ele.dadesENReftInter.value[posBarraRef].mostrarLiniaVertA:
                    ...
                    if len(build_ele.dadesENReftInter.value[posBarraRef].layer) == 0:
                        build_ele.dadesENReftInter.value[posBarraRef] = build_ele.dadesENReftInter.value[posBarraRef]._replace(layer = "TD_FIXACIO")
                    layer = build_ele.dadesENReftInter.value[posBarraRef].layer
                    polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.dadesENReftInter.value[posBarraRef].Altura, llargada-2, True, pointUbi, int(linia), layer)
                    if polyhedronCentral != []:
                        group_elems.append(polyhedronCentral[0])
                        group_elems_preview.append(polyhedronCentral[0])
                        group_elems.append(polyhedronCentral[3])
    ...
    if build_ele.SepararTDHoritzontalInf.value:
        for nBarresInf in range(1, build_ele.nBarresTDHoritzontalInf.value):
            elements , lHoritzontalPP, elements_model_eleList = crear_barres_inferiors_multiples(build_ele, doc, nBarresInf, mostrarActual)
    ...
    if build_ele.SepararTDHoritzontalSup.value:
        for nBarresInf in range(1, build_ele.nBarresTDHoritzontalSup.value):
            elements , lHoritzontalPP, elements_model_eleList = crear_barres_superiors_multiples(build_ele, doc, nBarresInf, mostrarActual)
            listHoritzontalPP.append(lHoritzontalPP)
            listElements.append(elements)
...
def update_mat_nListVert(build_ele):
    ...
    while len(build_ele.dadesTDVert.value) <= i:
        ...
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(esExtrem = build_ele.esExtrem.value)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(MostrarRecess = build_ele.MostrarRecessVert.value)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(MostrarCavitat = build_ele.MostrarCavitatVert.value)
...
def mostrar_valors_actuals(build_ele, i):
    ...
    if len(build_ele.dadesTDVert.value) <= i:
        ...
        build_ele.esExtrem.value = build_ele.dadesTDVert.value[i].esExtrem
        build_ele.MostrarRecessVert.value = build_ele.dadesTDVert.value[i].MostrarRecess
        build_ele.MostrarCavitatVert.value = build_ele.dadesTDVert.value[i].MostrarCavitat
...
def set_values(build_ele, i):
    ...
    while len(build_ele.listDesplVerticals.value) <= i:
        ...
        build_ele.listDesplVerticals.value[i] = build_ele.listDesplVerticals.value[i]._replace(mostrarLiniaVertA = False)
    ...
    while len(build_ele.dadesTDVert.value) <= i:
        ...
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(MostrarTDVertical = True)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(BarraAmple = 30)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(BarraAltura = 30)
        ...
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(BarraSuperior = "TD Superior")
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(BarraInferior = "TD Inferior")
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(Gruix = 1.5)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(EncaixSup = False)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(EncaixInf = False)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(Ample_forat_femellaVert = 15)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(Altura_forat_femellaVert = 3.75)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(Separacio_forat_femellaVert = 30)
        ...
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(FemellaSup = True)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(FemellaInf = True)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(esProvisional = False)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(esExtrem = False)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(MostrarRecess = True)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(MostrarCavitat = True)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(linia = 1)
        build_ele.dadesTDVert.value[i] = build_ele.dadesTDVert.value[i]._replace(layer = "TD_ESTRUCTURA")
...
def guardar_valors_hor(build_ele, nBarraVert, nHor):
    ...
    #build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor] = build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor]._replace(BarraHor = build_ele.BarresHorListToShow.value[0].BarraHor)
    #build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor] = build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor]._replace(Orientacio = build_ele.BarresHorListToShow.value[0].Orientacio)
    #build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor] = build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor]._replace(Posicio = build_ele.BarresHorListToShow.value[0].Posicio)
    #build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor] = build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor]._replace(AutoLongitud = build_ele.BarresHorListToShow.value[0].AutoLongitud)
    #build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor] = build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor]._replace(Longitud = build_ele.BarresHorListToShow.value[0].Longitud)
    #build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor] = build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor]._replace(BarraInici = build_ele.BarresHorListToShow.value[0].BarraInici)
    #build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor] = build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor]._replace(BarraFinal = build_ele.BarresHorListToShow.value[0].BarraFinal)
    #build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor] = build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor]._replace(Edit = build_ele.BarresHorListToShow.value[0].Edit)
    #build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor] = build_ele.BarresHorList.value[nBarraVert* NombreBarresHorInt + nHor]._replace(acabatEditar = build_ele.BarresHorListToShow.value[0].acabatEditar)
...
def createBoxForat(build_ele, i, forats, nForat):
    ...
    nBoxForat = BoxForat(random.random() * 3600, build_ele.dadesTDVert.value[i].BarraAmple, build_ele.dadesTDVert.value[i].BarraAltura, build_ele.BarraLlargadaVert.value, build_ele.BarraGruixVert.value,
    ...
    nHorInf = 0
    if build_ele.dadesTDVert.value[i].BarraInferior != "TD Inferior":
...
def createBoxForatCavitat(build_ele, i, forats, nForat):
    ...
    vectorCav = AllplanGeo.Matrix3D()
    vectorCav.SetValue(12, build_ele.listDesplVerticals.value[i].desplXAbs - (build_ele.dadesTDVert.value[i].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2) - alturaCavForat/2)
    vectorCav.SetValue(13, build_ele.listDesplVerticals.value[i].desplYAbs)
    ...
    if forats[nForat].orientacio == "Inf":
        vectorCav.SetValue(12, build_ele.listDesplVerticals.value[i].desplXAbs - (build_ele.dadesTDVert.value[i].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2) - (ampleCavForat - build_ele.dadesTDVert.value[i].BarraAmple)/2)
        vectorCav.SetValue(13, build_ele.listDesplVerticals.value[i].desplYAbs - alturaCavForat)

    elif forats[nForat].orientacio == "Sup":
        vectorCav.SetValue(12, build_ele.listDesplVerticals.value[i].desplXAbs - (build_ele.dadesTDVert.value[i].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2) - (ampleCavForat - build_ele.dadesTDVert.value[i].BarraAmple)/2)
        vectorCav.SetValue(13, build_ele.listDesplVerticals.value[i].desplYAbs + build_ele.dadesTDVert.value[i].BarraAltura)

    elif forats[nForat].orientacio == "Dre":
        vectorCav.Rotation(z_axis, AllplanGeo.Angle.FromDeg(90))
        vectorCav.SetValue(12, build_ele.listDesplVerticals.value[i].desplXAbs - (build_ele.dadesTDVert.value[i].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2) )
        vectorCav.SetValue(13, build_ele.listDesplVerticals.value[i].desplYAbs - (ampleCavForat - build_ele.dadesTDVert.value[i].BarraAltura)/2)

    elif forats[nForat].orientacio == "Esq":
        vectorCav.Rotation(z_axis, AllplanGeo.Angle.FromDeg(90))
        vectorCav.SetValue(12, build_ele.listDesplVerticals.value[i].desplXAbs - (build_ele.dadesTDVert.value[i].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2) + build_ele.dadesTDVert.value[i].BarraAmple + alturaCavForat)
        vectorCav.SetValue(13, build_ele.listDesplVerticals.value[i].desplYAbs - (ampleCavForat - build_ele.dadesTDVert.value[i].BarraAltura)/2)
    ...
    if build_ele.dadesTDVert.value[i].MostrarTDVertical:
        table_views_object2 = [View2D3D ([AllplanBasisElements.ModelElement3D(common_propsObject, horitzontal_BrepObject2)])]
        ...
        #if build_ele.dadesTDVert.value[i].MostrarRecess and build_ele.MostrarCavitatsRecess.value:
        ...
        #if build_ele.dadesTDVert.value[i].MostrarCavitat and build_ele.MostrarCavitats.value:
        if build_ele.MostrarCavitats.value:
            group_elems.append(PythonPart ("Cavitat_Horitzontal", parameter_list = horitzontalPPOBject2A.get_params_list(),
                                    hash_value = horitzontalPPOBject2A.hash(), python_file = horitzontalPPOBject2A.filename(),
                                    views = table_views_object_2, matrix = vectorCav, common_props = common_propsObject2, attribute_list = table_attr_listObject))
...
def createBoxForatCavitatXPS(build_ele, i, forats, nForat):
    ...
    #    alturaCavForat = 60
    alturaCavForat = build_ele.MesuraXPS.value - build_ele.dadesTDVert.value[i].BarraAltura - build_ele.listDesplVerticals.value[i].desplYAbs
    ...
    if forats[nForat].orientacio == "Sup":
        ...
        vectorCan.SetValue(12, build_ele.listDesplVerticals.value[i].desplXAbs - (build_ele.dadesTDVert.value[i].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2) - (ampleCavForat - build_ele.dadesTDVert.value[i].BarraAmple)/2)
        vectorCan.SetValue(13, build_ele.listDesplVerticals.value[i].desplYAbs - alturaCavForat)
        ...
        vectorCan.SetValue(12, build_ele.listDesplVerticals.value[i].desplXAbs - (build_ele.dadesTDVert.value[i].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2) - (ampleCavForat - build_ele.dadesTDVert.value[i].BarraAmple)/2)
        vectorCan.SetValue(13, build_ele.listDesplVerticals.value[i].desplYAbs + build_ele.dadesTDVert.value[i].BarraAltura + alturaCavForat + 20)
        ...
        vectorCan.SetValue(12, build_ele.listDesplVerticals.value[i].desplXAbs - (build_ele.dadesTDVert.value[i].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2) - alturaCavForat - 20)
        vectorCan.SetValue(13, build_ele.listDesplVerticals.value[i].desplYAbs - (ampleCavForat - build_ele.dadesTDVert.value[i].BarraAltura)/2 + 2)
        ...
        vectorCan.SetValue(12, build_ele.listDesplVerticals.value[i].desplXAbs - (build_ele.dadesTDVert.value[i].BarraAmple/2 - build_ele.dadesTDVert.value[0].BarraAmple/2) + build_ele.dadesTDVert.value[i].BarraAmple + alturaCavForat )
        vectorCan.SetValue(13, build_ele.listDesplVerticals.value[i].desplYAbs - (ampleCavForat - build_ele.dadesTDVert.value[i].BarraAltura)/2 + 2)
...
def createBoxForatHorInt(build_ele, posBarraHor, forats, i, nForats):
    ...
    vectorCan.SetValue(12, build_ele.dadesTDHortInter.value[posBarraHor].desplX + build_ele.listDesplVerticals.value[i].desplXAbs + build_ele.dadesTDVert.value[i].BarraAmple/2 + build_ele.dadesTDVert.value[0].BarraAmple/2 -build_ele.dadesTDVert.value[i].Gruix + 2 )#+ build_ele.ForatsHorInt.value[posBarraHor].Posicio)#- build_ele.dadesTDHortInter.value[posBarraHor].desplX)
...
def createBoxForatCavitatHorInt(build_ele, posBarraHor, forats, i, nForat):
    ...
    vectorCav.SetValue(12, build_ele.dadesTDHortInter.value[posBarraHor].desplX + build_ele.listDesplVerticals.value[i].desplXAbs + build_ele.dadesTDVert.value[i].BarraAmple/2 + build_ele.dadesTDVert.value[0].BarraAmple/2 -build_ele.dadesTDVert.value[i].Gruix + 2 + forats[nForat].Posicio - llargadaCavForat/2)#+ build_ele.ForatsHorInt.value[posBarraHor].Posicio)#- build_ele.dadesTDHortInter.value[posBarraHor].desplX)
    #vectorCav.SetValue(13, build_ele.dadesTDVert.value[i].desplYAbs)
...
def createBoxForatCavitatHorIntXPS(build_ele, posBarraHor, forats, i, nForat):
    ...
    if forats[nForat].orientacio == "Sup" or forats[nForat].orientacio == "Inf":
        vectorCan.SetValue(12, build_ele.dadesTDHortInter.value[posBarraHor].desplX + build_ele.listDesplVerticals.value[i].desplXAbs + build_ele.dadesTDVert.value[i].BarraAmple/2 + build_ele.dadesTDVert.value[0].BarraAmple/2 -build_ele.dadesTDVert.value[i].Gruix + 2 + forats[nForat].Posicio - llargadaCavForat/2 + 15)

    else:
        vectorCan.SetValue(12, build_ele.dadesTDHortInter.value[posBarraHor].desplX + build_ele.listDesplVerticals.value[i].desplXAbs + build_ele.dadesTDVert.value[i].BarraAmple/2 + build_ele.dadesTDVert.value[0].BarraAmple/2 -build_ele.dadesTDVert.value[i].Gruix + 2 + forats[nForat].Posicio - llargadaCavForat/2 + 33)
...
def guardar_valors_inici(build_ele, nVer):
    ...
    if build_ele.IntegerTDSelectorAnterior.value == -1:
        ...
        if build_ele.IntegerTDSelectorAnterior.value != nVer or (build_ele.SelectorPPAnt.value != build_ele.SelectorPP.value):
            ...
            if build_ele.SelectorPP == 1:
                for i in range(0,len(build_ele.BarresHorListToShow.value)):
                    BarresHor = build_ele.BarresHorListToShow.value[i]
                    #if (not BarresHor.Edit and BarresHor.acabatEditar) or (not BarresVert.Edit or BarresVert.acabatEditar):
                    if BarresHor.Edit or BarresHor.acabatEditar:
                        guardar = False
...
def crear_barres_inferiors_multiples(build_ele, doc, nBarraInf, mostrarActual):
        ...
        if build_ele.invertirEncaixInf.value:
            ...
            for i in range(0,len(build_ele.listDesplVerticals.value)):
                ...
                if build_ele.dadesTDVert.value[i].EncaixInf:
                    ...
                    matrixOr.append("Inf")
            trans_list = horitzontalPP.create_PP_positions_femelles(listAmples, listAltures, matrixPosX, matrixPosY, matrixMostrarInf, offsetXI, matrixOr, build_ele.Ample_forat_femellaVert.value, build_ele.BarraLlargada.value, build_ele.desplYI.value, build_ele.FemellesHorIntAuxInf.value, build_ele.desplXI.value)#
        else:
            for i in range(0,len(build_ele.listDesplVerticals.value)):
                matrixOffsetY.append(  build_ele.listDesplVerticals.value[i].desplY + build_ele.dadesTDVert.value[i].BarraAltura - build_ele.desplYI.value)
            trans_list = horitzontalPP.create_PP_positions_encaix(listAmples2, matrixPosX, matrixPosY, matrixcentrar, matrixMostrar, matrixOffsetY, offsetXI, 'Sup', build_ele.BarraLlargada.value)
    ...
    if build_ele.MostrarTDHoritzontalInf.value:
        ...
        horitzontalPPOBject = PP_TD_Horitzontal(random.random() * 3600,0, build_ele.BarraAmpleInf.value, build_ele.BarraAlturaInf.value+10, build_ele.BarraLlargada.value+10, 0,#DistanciaEntreTD, BarraAmple, BarraAltura,BarraLlargada, BarraGruix,
                                    False, common_propsObject.Color, common_propsObject.Layer,# IsUseGlobalPropVert, FounColorVert, BarraLayerVert,
                                    [], [], [],#ColisPar, PotaPar, #matrius
                                    0, 0, 0,#Ample_forat_femella, Altura_forat_femella, Separacio_forat_femella,
                                    [], #Femelles, #matriu
        ...
        horitzontalPPOBjectA = PP_TD_Horitzontal(random.random() * 3600,0, build_ele.BarraAmpleInf.value, build_ele.BarraAlturaInf.value+10, build_ele.BarraLlargada.value + 10, 0,#DistanciaEntreTD, BarraAmple, BarraAltura,BarraLlargada, BarraGruix,
                                    False, common_propsObject2.Color, common_propsObject2.Layer,# IsUseGlobalPropVert, FounColorVert, BarraLayerVert,
                                    [], [], [],#ColisPar, PotaPar, #matrius
                                    0, 0, 0,#Ample_forat_femella, Altura_forat_femella, Separacio_forat_femella,
                                    [], #Femelles, #matriu
...
def crear_barres_superiors_multiples(build_ele, doc, nBarraSup, mostrarActual):
    ...
    largadaSup = build_ele.BarraLlargada.value
    if not build_ele.mantenirLlargadaSup.value:
        llargadaSup = build_ele.BarraLlargadaSupInd.value
...
def crearLlistaReforc(build_ele):
    ...
    while len(build_ele.BarresRefList.value) > build_ele.NumBarresRef.value:
            ...
            if build_ele.dadesTDVert.value[j].BarraInferior != "TD Inferior" and build_ele.dadesTDVert.value[j].BarraInferior != "TD Superior":
                ...
                if len(build_ele.dadesTDVert.value[j].BarraInferior) > 3:
                    if len(build_ele.dadesTDVert.value[j].BarraInferior) == 7:
                        ...
                        nHorInf = int(build_ele.dadesTDVert.value[j].BarraInferior[-1])
            alturaInf = build_ele.dadesTDHortInter.value[nHorInf].Altura
    Lprovisionals = LProvisional(random.random() * 3600, build_ele.dadesTDVert.value[j].BarraAmple + 2, build_ele.dadesTDVert.value[j].BarraAltura, build_ele.dadesTDVert.value[j].BarraAlcada - 76 - alturaInf, build_ele.dadesTDVert.value[j].Gruix,
...
def buscar_anterior_mes_proper(build_ele, posicioX):
    ...
    for nBarra in range(1,build_ele.IntegerTDSelector.value):
        if build_ele.listDesplVerticals.value[nBarra].desplXAbs < posicioX and build_ele.listDesplVerticals.value[nBarra].desplXAbs >= posicioAntMesPropera and build_ele.dadesTDVert.value[nBarra].MostrarTDVertical and not build_ele.dadesTDVert.value[nBarra].esProvisional and  build_ele.dadesTDVert.value[nBarra].BarraSuperior == "TD Superior" and  build_ele.dadesTDVert.value[nBarra].BarraInferior == "TD Inferior" :
...
def buscar_seguent_mes_proper(build_ele, posicioX):
    ...
    for nBarra in range(1,build_ele.IntegerTDSelector.value-1):
        if build_ele.listDesplVerticals.value[nBarra].desplXAbs > posicioX and build_ele.listDesplVerticals.value[nBarra].desplXAbs <= posicioSegMesPropera and build_ele.dadesTDVert.value[nBarra].MostrarTDVertical and not build_ele.dadesTDVert.value[nBarra].esProvisional and  build_ele.dadesTDVert.value[nBarra].BarraSuperior == "TD Superior" and  build_ele.dadesTDVert.value[nBarra].BarraInferior == "TD Inferior" :
...
def mostrar_tubHorInt(build_ele, nHorInt):
    while len(build_ele.BarresHorListToShow.value) > 1:
        build_ele.BarresHorListToShow.value.pop()

    if nHorInt != build_ele.SelectorTDHTotalAnt.value or (build_ele.SelectorPP.value == 1 and build_ele.SelectorPPAnt.value!=1):#error selector Hor
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(Edit = True)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(acabatEditar = True)
        #mostrar_valors_hor(build_ele, 0, nHorInt)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(BarraHor = build_ele.BarresHorList.value[nHorInt].BarraHor)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(Orientacio = build_ele.BarresHorList.value[nHorInt].Orientacio)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(Posicio = build_ele.BarresHorList.value[nHorInt].Posicio)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(AutoLongitud = build_ele.BarresHorList.value[nHorInt].AutoLongitud)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(Longitud = build_ele.BarresHorList.value[nHorInt].Longitud)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(BarraInici = build_ele.BarresHorList.value[nHorInt].BarraInici)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(BarraFinal = build_ele.BarresHorList.value[nHorInt].BarraFinal)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(Edit = build_ele.BarresHorList.value[nHorInt].Edit)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(acabatEditar = build_ele.BarresHorList.value[nHorInt].acabatEditar)

        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(MostrarRecess = build_ele.BarresHorList.value[nHorInt].MostrarRecess)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(MostrarCavitat = build_ele.BarresHorList.value[nHorInt].MostrarCavitat)

        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(Xapa = build_ele.BarresHorList.value[nHorInt].Xapa)
        build_ele.BarresHorListToShow.value[0] = build_ele.BarresHorListToShow.value[0]._replace(Layer = build_ele.BarresHorList.value[nHorInt].Layer)

        mostrar_valors_hor(build_ele, 0, nHorInt)

    if build_ele.BarresHorList.value[nHorInt].Edit:
        #guardar_valors_hor(build_ele, 0, nHorInt)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(BarraHor = build_ele.BarresHorListToShow.value[0].BarraHor)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(Orientacio = build_ele.BarresHorListToShow.value[0].Orientacio)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(Posicio = build_ele.BarresHorListToShow.value[0].Posicio)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(AutoLongitud = build_ele.BarresHorListToShow.value[0].AutoLongitud)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(Longitud = build_ele.BarresHorListToShow.value[0].Longitud)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(BarraInici = build_ele.BarresHorListToShow.value[0].BarraInici)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(BarraFinal = build_ele.BarresHorListToShow.value[0].BarraFinal)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(Edit = build_ele.BarresHorListToShow.value[0].Edit)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(acabatEditar = build_ele.BarresHorListToShow.value[0].acabatEditar)

        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(MostrarRecess = build_ele.BarresHorListToShow.value[0].MostrarRecess)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(MostrarCavitat = build_ele.BarresHorListToShow.value[0].MostrarCavitat)

        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(Xapa = build_ele.BarresHorListToShow.value[0].Xapa)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(ProfunditatXapa = build_ele.BarresHorListToShow.value[0].ProfunditatXapa)
        build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(Layer = build_ele.BarresHorListToShow.value[0].Layer)
...
def mostrar_valors_Ref(build_ele, nBarraVert):
    ...
    build_ele.SelectorLiniaRef.value = build_ele.dadesENReftInter.value[nBarraVert].linia
    build_ele.SelectorLayerRef.value = build_ele.dadesENReftInter.value[nBarraVert].layer
...
def guardar_valors_Ref(build_ele, nBarraVert):
    ...
    build_ele.dadesENReftInter.value[nBarraVert ] = build_ele.dadesENReftInter.value[nBarraVert ]._replace(linia = build_ele.SelectorLiniaRef.value)
    build_ele.dadesENReftInter.value[nBarraVert ] = build_ele.dadesENReftInter.value[nBarraVert ]._replace(layer = build_ele.SelectorLayerRef.value)
...
class TD_Conjunt_8():
    ...
    '''
    def __init__(self, zUnique = 0, comprovarDEN = False, NomTD = "TD",  DistanciaEntreTD = 1170, SelectorPP = 1,
                 SelectorTDH = "TD Inferior", SelectorTDHInf = "Tub", SelectorTDHSup = "Tub",
        ...
        self.SelectorPP = SelectorPP

        self.SelectorTDH = SelectorTDH
