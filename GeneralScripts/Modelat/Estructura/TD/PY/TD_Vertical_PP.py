...
def create_element(build_ele, doc):
    ...
    TDVertical = PP_TD_Vertical(build_ele.zUnique.value, build_ele.BarraAmple.value, build_ele.BarraAltura.value, build_ele.BarraLlargada.value, build_ele.BarraGruix.value,
    ...
    pythonpart = PythonPart ("PP_TD_Vertical",
...
class PP_TD_Vertical():
    ...
    def __repr__(self):
        return 'PP_TD_Vertical(zUnique=%s, BarraAmple=%s, BarraAltura=%s, BarraLlargada=%s, BarraGruix=%s,' \
