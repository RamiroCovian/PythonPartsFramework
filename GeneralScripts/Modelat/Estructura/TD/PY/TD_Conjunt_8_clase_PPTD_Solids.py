...
from Utils import LibraryBitmapPreview, TextReferencePointPosition
...
KN_XPS_RECESS = 40054
KN_XPS_CAVITAT = 40055
KN_PLD_RECESS = 40057
KN_ESPONJA = 40067
KN_ELECTRICITAT_REINFORCEMENT = 40073
KN_AIGUA_REINFORCEMENT = 40074
TD_ESTRUCTURA = 40001
TD_FIXACIO = 40036
TD_NO_CARAGOLAR = 40037
...
def create_element_class(build_ele, doc, placement_mat = AllplanGeo.Matrix3D(), element_listTD = [], Pared = [], TDLlargada = -1.0, TDAlcada = -1.0, numIDParent = 1 ):# type: ignore
    """
    ...
    set_layers(build_ele, numIDParent)
    ...
    if TDLlargada != -1:
        build_ele.BarraLlargadaTD.value = TDLlargada
    if TDAlcada != -1:
        build_ele.BarraLlargadaVert.value = TDAlcada
    #if len(element_listTD) > 0 : #and esInici:
    #    values_from_solid3D(build_ele, placement_mat, element_listTD, Pared)
        #asignar_colindants(build_ele,nVer)
    ...
    if build_ele.SelectorPPTD.value == 1 and build_ele.SelectorTDHTD.value == "TD Inferior":
        ...
        pointUbi = AllplanGeo.Point3D(build_ele.PosicioXBalconera.value + placement_mat[12], 0 + placement_mat[13], build_ele.PosicioZBalconera.value + + placement_mat[14])
        lineX = create_polyline_interior(build_ele, 0, 0, build_ele.AmpleBalconera.value, True, pointUbi, posYdiferent= placement_mat[13])
        if lineX != []:
        ...
        lineZ = create_polyline_interior(build_ele, 0,0,build_ele.LlargadaBalconera.value, False, pointUbi, posYdiferent= placement_mat[13])
        if lineZ != []:
        ...
        pointUbi = AllplanGeo.Point3D(build_ele.PosicioXBalconera.value + placement_mat[12], 0 + placement_mat[13] , build_ele.PosicioZBalconera.value + build_ele.LlargadaBalconera.value + + placement_mat[14])
        lineX = create_polyline_interior(build_ele, 0, 0, build_ele.AmpleBalconera.value, True, pointUbi, posYdiferent= placement_mat[13])
        if lineX != []:
            #group_elems.append(lineX[0])
            group_elems_preview.append(lineX[0])
            ...
            #model_ele_list2.append(AllplanBasisElements.ModelElement3D(lineX[1], lineX[0]))
            #preview_ele_list.append(AllplanBasisElements.ModelElement3D(lineX[1], lineX[2]))
        pointUbi = AllplanGeo.Point3D(build_ele.PosicioXBalconera.value + build_ele.AmpleBalconera.value + placement_mat[12], 0 + placement_mat[13], build_ele.PosicioZBalconera.value+ placement_mat[14])
        lineZ = create_polyline_interior(build_ele, 0,0,build_ele.LlargadaBalconera.value, False, pointUbi, posYdiferent= placement_mat[13])
        if lineZ != []:
            #group_elems.append(lineZ[0])
            group_elems_preview.append(lineZ[0])
    ...
    if build_ele.SelectorTDHInf.value == "Tub":
        ...
        horitzontalPP = PP_TD_Horitzontal_Inf( random.random() * 3600, build_ele.BarraAmpleInf.value, build_ele.BarraAlturaInf.value, llargadaInf, build_ele.BarraGruixInf.value, build_ele.InvertirTDHoritzontalInf.value, build_ele.InvertirTDHoritzontalInf2.value,
                    [],
                    build_ele.IsUseGlobalProp.value, vermellInf, TD_ESTRUCTURA)
        horitzontalPPPrev = PP_TD_Horitzontal_Inf( random.random() * 3601, build_ele.BarraAmpleInf.value, build_ele.BarraAlturaInf.value, llargadaInf, build_ele.BarraGruixInf.value, build_ele.InvertirTDHoritzontalInf.value, build_ele.InvertirTDHoritzontalInf2.value,
                    [],
                    build_ele.IsUseGlobalProp.value, vermellInfPrev, TD_ESTRUCTURA)
    ...
    if build_ele.SelectorTDHSup.value == "Tub":
        ...
        horitzontalPP2 = PP_TD_Horitzontal_Inf( random.random() * 3600, build_ele.BarraAmpleSupL.value, build_ele.BarraAlturaSupL.value, llargadaSup, build_ele.BarraGruixSupL.value, build_ele.InvertirTDHoritzontalSup.value, build_ele.InvertirTDHoritzontalSup2.value,
                    ...
                    build_ele.IsUseGlobalProp.value, build_ele.FounColorSup.value, TD_ESTRUCTURA,
                    femellesSupL,
    ...
    common_propsObjectInf.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)#56811#build_ele.BarraLayer.value#64178
    #common_propsObject.Color = 31 #blanc

    common_propsObjectInf2 = AllplanBaseElements.CommonProperties()
    common_propsObjectInf2.Layer = KN_XPS_CAVITAT#(KN_XPS_CAVITAT)
    ...
    if build_ele.MostrarTDHoritzontalInf.value :
        ...
        if build_ele.SepararTDHoritzontalInf.value:
            if build_ele.listDesplHoritzontalsInf.value[0].mostrarLiniaA:
                ...
                pointUbi = AllplanGeo.Point3D(desplXSeparat + vectorH1[12], vectorH1[13] + build_ele.listDesplHoritzontalsInf.value[0].BarraAmpleInf/2 + build_ele.listDesplHoritzontalsInf.value[0].desplLinA, vectorH1[14] +  build_ele.listDesplHoritzontalsInf.value[0].BarraAlturaInf/2)
                linia = build_ele.SelectorLiniaInf.value[len(build_ele.SelectorLiniaInf.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central,build_ele.listDesplHoritzontalsInf.value[0].BarraAmpleInf,build_ele.listDesplHoritzontalsInf.value[0].BarraLlargadaInf, True, pointUbi, int(linia), build_ele.SelectorLayerInf.value, posYdiferent= placement_mat[13])
            ...
            if build_ele.listDesplHoritzontalsInf.value[0].mostrarLiniaB:
                punt_central = desplXSeparat + build_ele.listDesplHoritzontalsInf.value[0].desplX + build_ele.listDesplHoritzontalsInf.value[0].BarraAlturaInf/2
                pointUbi = AllplanGeo.Point3D(desplXSeparat + vectorH1[12], vectorH1[13] + build_ele.listDesplHoritzontalsInf.value[0].BarraAmpleInf/2 + build_ele.listDesplHoritzontalsInf.value[0].desplLinB, vectorH1[14] +  build_ele.listDesplHoritzontalsInf.value[0].BarraAlturaInf/2)
                linia = build_ele.SelectorLiniaInf.value[len(build_ele.SelectorLiniaInf.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central,build_ele.listDesplHoritzontalsInf.value[0].BarraAmpleInf,build_ele.listDesplHoritzontalsInf.value[0].BarraLlargadaInf, True, pointUbi, int(linia), build_ele.SelectorLayerInf.value, posYdiferent= placement_mat[13])
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
            ...
            if build_ele.mostrarLiniaIntInf1.value:
                ...
                linia = build_ele.SelectorLiniaInf.value[len(build_ele.SelectorLiniaInf.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.BarraAmpleInf.value, build_ele.BarraLlargadaTD.value + build_ele.ExtenderInf.value, True, pointUbi, int(linia), build_ele.SelectorLayerInf.value, posYdiferent= placement_mat[13])
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
                    group_elems_preview.append(polyhedronCentral[0])
                    group_elems.append(polyhedronCentral[3])
            ...
            if build_ele.mostrarLiniaIntInf2.value:
                ...
                linia = build_ele.SelectorLiniaInf.value[len(build_ele.SelectorLiniaInf.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.BarraAmpleInf.value, build_ele.BarraLlargadaTD.value, True, pointUbi, int(linia), build_ele.SelectorLayerInf.value, posYdiferent= placement_mat[13])
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
                    group_elems_preview.append(polyhedronCentral[0])
                    group_elems.append(polyhedronCentral[3])
    ...
    common_propsObjectSup.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)
    common_propsObjectSup2.Layer = KN_XPS_CAVITAT#(KN_XPS_CAVITAT)
    ...
    if build_ele.MostrarTDHoritzontalSup.value:
        ...
        if build_ele.SepararTDHoritzontalSup.value:
            if build_ele.listDesplHoritzontalsSup.value[0].mostrarLiniaA:
                ...
                pointUbi = AllplanGeo.Point3D(desplXSeparatSup + vectorH2[12], placement_mat[13] + build_ele.listDesplHoritzontalsSup.value[0].BarraAmpleSup/2 + build_ele.listDesplHoritzontalsSup.value[0].desplLinA, vectorH2[14] +  build_ele.listDesplHoritzontalsSup.value[0].BarraAlturaSup/2)
                linia = build_ele.SelectorLiniaSup.value[len(build_ele.SelectorLiniaSup.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central,build_ele.listDesplHoritzontalsSup.value[0].BarraAmpleSup,build_ele.listDesplHoritzontalsSup.value[0].BarraLlargadaSup, True, pointUbi, int(linia), build_ele.SelectorLayerSup.value, posYdiferent= placement_mat[13])
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
                    group_elems_preview.append(polyhedronCentral[0])
                    group_elems.append(polyhedronCentral[3])
            ...
            if build_ele.listDesplHoritzontalsSup.value[0].mostrarLiniaB:
                punt_central = placement_mat[12] + desplXSeparatSup + build_ele.listDesplHoritzontalsSup.value[0].desplX + build_ele.listDesplHoritzontalsSup.value[0].BarraAlturaSup/2
                pointUbi = AllplanGeo.Point3D(desplXSeparatSup + vectorH2[12], placement_mat[13] + build_ele.listDesplHoritzontalsSup.value[0].BarraAmpleSup/2 + build_ele.listDesplHoritzontalsSup.value[0].desplLinB, vectorH2[14] +  build_ele.listDesplHoritzontalsSup.value[0].BarraAlturaSup/2)
                linia = build_ele.SelectorLiniaSup.value[len(build_ele.SelectorLiniaSup.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central,build_ele.listDesplHoritzontalsSup.value[0].BarraAmpleSup,build_ele.listDesplHoritzontalsSup.value[0].BarraLlargadaSup, True, pointUbi, int(linia), build_ele.SelectorLayerSup.value, posYdiferent= placement_mat[13])
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
            ...
            if build_ele.mostrarLiniaIntSup1.value:
                ...
                pointUbi = AllplanGeo.Point3D(vectorH2[12], placement_mat[13] + build_ele.BarraAmpleSup.value/2 + build_ele.desplLiniaIntSup1.value , vectorH2[14] + build_ele.BarraAlturaSup.value/2)
                linia = build_ele.SelectorLiniaSup.value[len(build_ele.SelectorLiniaSup.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.BarraAmpleSup.value, llargadaSup, True, pointUbi, int(linia), build_ele.SelectorLayerSup.value, posYdiferent= placement_mat[13])

                if build_ele.SelectorTDHSup.value == "L":
                    punt_central = vectorH2[12] + build_ele.desplXSL.value + build_ele.BarraAlturaSupL.value/2
                    pointUbi = AllplanGeo.Point3D(vectorH2[12], placement_mat[13] + build_ele.BarraAmpleSupL.value/2 + build_ele.desplLiniaIntSup1.value , vectorH2[14] + build_ele.BarraAlturaSupL.value/2)
                    polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.BarraAmpleSupL.value, llargadaSup, True, pointUbi, int(linia), build_ele.SelectorLayerSup.value, posYdiferent= placement_mat[13])
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
                    group_elems_preview.append(polyhedronCentral[0])
                    group_elems.append(polyhedronCentral[3])
            ...
            if build_ele.mostrarLiniaIntSup2.value:
                punt_central = vectorH2[12] + build_ele.desplXS.value + build_ele.BarraAlturaSup.value/2
                pointUbi = AllplanGeo.Point3D(vectorH2[12], placement_mat[13] + build_ele.BarraAmpleSup.value/2 + build_ele.desplLiniaIntSup2.value , vectorH2[14] + build_ele.BarraAlturaSup.value/2)
                linia = build_ele.SelectorLiniaSup.value[len(build_ele.SelectorLiniaSup.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.BarraAmpleSup.value, llargadaSup, True, pointUbi, int(linia), build_ele.SelectorLayerSup.value, posYdiferent= placement_mat[13])
                if build_ele.SelectorTDHSup.value == "L":
                    punt_central = vectorH2[12] + build_ele.desplXSL.value + build_ele.BarraAlturaSupL.value/2
                    pointUbi = AllplanGeo.Point3D(vectorH2[12], placement_mat[13] + build_ele.BarraAmpleSupL.value/2 + build_ele.desplLiniaIntSup2.value , vectorH2[14] + build_ele.BarraAlturaSupL.value/2)
                    polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.BarraAmpleSupL.value, llargadaSup, True, pointUbi, int(linia), build_ele.SelectorLayerSup.value, posYdiferent= placement_mat[13])
    ...
    if not build_ele.ReduirTempsCarrega.value:
        try:
            ...
            for matrix in trans_list:
                ...
                common_propsObjectVert.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)
                common_propsObjectVert2.Layer = KN_XPS_CAVITAT#(KN_XPS_CAVITAT)
                ...
                try:
                            ...
                            if NBarraInici < len(trans_list)  and build_ele.BarresHorList.value[posBarraHor].BarraHor:
                                ...
                                for nBarraVertical in range(0, len(build_ele.dadesTDVertTD.value)-1):
                                    if build_ele.dadesTDVertTD.value[nBarraVertical].BarraInferior == "Tub " +str(posBarraHor):#Numeracio malament #+ str(j*(posBarraHor - inici)):
                                        ...
                                        TDHorCollection = collections.namedtuple('StirrupList', 'Femella FemellaOr PosFemellaX PosFemellaY Separacio_forat_femella Separator')
                                ...
                                if build_ele.BarresHorList.value[posBarraHor].Xapa:
                                    ...
                                    if build_ele.BarresHorList.value[posBarraHor].Layer == "KN_ELECTRICITAT_REINFORCEMENT":
                                        GlobalPropLayer = KN_ELECTRICITAT_REINFORCEMENT#(KN_ELECTRICITAT_REINFORCEMENT)
                                    elif build_ele.BarresHorList.value[posBarraHor].Layer == "KN_AIGUA_REINFORCEMENT":
                                        GlobalPropLayer = KN_AIGUA_REINFORCEMENT#(KN_AIGUA_REINFORCEMENT)
                                ...
                                if build_ele.BarresAdjList.value[posBarraHor].BarraAdj:
                                    ...
                                    common_propsObjectNovaHor.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)
                                ...
                                common_propsObjectAdj.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)
                                if build_ele.BarresHorList.value[posBarraHor].Xapa:
                                    if build_ele.BarresHorList.value[posBarraHor].Layer == "KN_ELECTRICITAT_REINFORCEMENT":
                                        common_propsObjectAdj.Layer = KN_ELECTRICITAT_REINFORCEMENT#(KN_ELECTRICITAT_REINFORCEMENT)
                                    elif build_ele.BarresHorList.value[posBarraHor].Layer == "KN_AIGUA_REINFORCEMENT":
                                        common_propsObjectAdj.Layer = KN_AIGUA_REINFORCEMENT#(KN_AIGUA_REINFORCEMENT)
                                common_propsObjectAdj2.Layer = KN_XPS_CAVITAT#(KN_XPS_CAVITAT)
                                colorCavitat = getColorCavitat(build_ele.dadesTDHortInter.value[posBarraHor].Ample)
                                ...
                                if matrix_Aux[12] - placement_mat[12] < build_ele.BarraLlargadaTD.value + build_ele.ExtenderInf.value:
                                    ...
                                    if build_ele.BarresHorList.value[posBarraHor].Xapa:
                                        ...
                                        lineX = create_polyline_interior(build_ele, punt_central+5, build_ele.dadesTDHortInter.value[posBarraHor].Altura - 10, llargada-10, True, pointUbi, int(linia), layer, posYdiferent= placement_mat[13] + 15)
                                        if lineX != []:
                                            #group_elems.append(lineX[0])
                                            group_elems.append(lineX[0])
                                        ...
                                        if lineX != []:
                                            ...
                                            group_elems_preview.append(lineX[3])
                                        pointUbi = AllplanGeo.Point3D(matrix_Aux[12] + 5, matrix_Aux[13] + build_ele.dadesTDHortInter.value[posBarraHor].Ample/2 + build_ele.dadesTDHortInter.value[posBarraHor].desplLinB, matrix_Aux[14] + 5 )
                                        lineX = create_polyline_interior(build_ele, punt_central+5, build_ele.dadesTDHortInter.value[posBarraHor].Altura - 10, build_ele.dadesTDHortInter.value[posBarraHor].Altura-10, False, pointUbi, int(linia), layer, posYdiferent= placement_mat[13] + 15)
                                        if lineX != []:
                                            #group_elems.append(lineX[0])
                                            group_elems.append(lineX[0])
                                            group_elems.append(lineX[3])
                                    ...
                                    if build_ele.dadesTDHortInter.value[posBarraHor].mostrarLiniaVertA:
                                        ...
                                        if (len(build_ele.dadesTDHortInter.value[posBarraHor].layer) > 1):
                                            ...
                                            layer = "TD_FIXACIO"
                                        polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.dadesTDHortInter.value[posBarraHor].Altura, llargada, True, pointUbi, int(linia), layer, posYdiferent= placement_mat[13])
                                        if polyhedronCentral != []:
                                            group_elems.append(polyhedronCentral[0])
                                            group_elems_preview.append(polyhedronCentral[0])
                                            group_elems.append(polyhedronCentral[3])
                                    ...
                                    if build_ele.MostrarTDNums.value:
                                        ...
                                        vertx = AllplanGeo.Point3D(matrix_Aux[12], matrix_Aux[13] - placement_mat[13],  matrix_Aux[14] - placement_mat[14])
                    ...
                    print("no s'ha creat interior:" + str(posBarraHor), e)
                ...
                try:
                    ...
                    if inici+final >= len(build_ele.BarresFrontList.value) or inici+final >= len(build_ele.dadesFront.value):
                        set_valors_Frontals(build_ele,inici+final)
                        set_values_BarresFront(build_ele, inici+final)

                    encaixosAux = []
                    listLong = []
                    for barraFrontal in range(inici, inici+final):
                        if len(build_ele.BarresFrontList.value) <= barraFrontal:
                            pass
                        ...
                        if build_ele.BarresFrontList.value[barraFrontal].BarraFront:
                            ...
                            common_propsObjectNovaHorFront.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)
                            common_propsObjectNovaHorFront2.Layer = KN_XPS_CAVITAT#(KN_XPS_CAVITAT)
                    ...
                    print("No s'ha creat la barra Frontal correctament. Error: [" + str(barraFrontal) + "]", e)
                ...
                if j< len(matrixMostrar):
                    if matrixMostrar[j] and matrix0[12] - placement_mat[12]< build_ele.BarraLlargadaTD.value + build_ele.ExtenderInf.value:
                        ...
                        if build_ele.listDesplVerticalsTD.value[j].mostrarLiniaVertA:
                            ...
                            if len(str(build_ele.dadesTDVertTD.value[j].linia))< 6  or build_ele.dadesTDVertTD.value[j].linia == '':
                            ...
                            polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.dadesTDVertTD.value[j].BarraAltura, BarrallargadaVert, False, pointUbi, int(linia), layer, posYdiferent= placement_mat[13])
                            if polyhedronCentral != []:
                                group_elems.append(polyhedronCentral[0])
                                group_elems_preview.append(polyhedronCentral[0])
                                group_elems.append(polyhedronCentral[3])
                        ...
                        if build_ele.MostrarTDNums.value:
                            ...
                            posYNum = 20
                            '''
                            if build_ele.dadesTDVertTD.value[j].RotarTub: #Vertical
                                colorNum = 4
                                posYNum = 80
                                vertx = AllplanGeo.Point3D(matrix0[12] , matrix0[13],   matrix0[14])
                            else: #horitzontal
                            '''
                            colorNum = 8
                            #vertx = AllplanGeo.Point3D(matrix0[12] , matrix0[13] - placement_mat[13],   matrix0[14] - placement_mat[14])
                            vertx = AllplanGeo.Point3D(matrix0[12] , matrix0[13] ,   matrix0[14] )

                            preview_symbols.add_text(text=              str(j),
                                                reference_point=   vertx + AllplanGeo.Point3D(posXNum,posYNum,0),
                                                ref_pnt_pos=       TextReferencePointPosition.CENTER_RIGHT,
                                                height=            build_ele.tamanyNumId.value*5,
                                                color=             colorNum,
    ...
    try:
        ...
        for posBarraRef in range(inici, final):#recorrer totes les Barres Reforcs de cada vertical
            ...
            if build_ele.BarresRefListTD.value[posBarraRef].BarraRef:
                ...
                common_propsR.Layer = TD_ESTRUCTURA#56811#build_ele.BarraLayer.value#64178
                ...
                common_propsObject.Layer = KN_XPS_CAVITAT#KN_XPS_RECESS #56811#build_ele.BarraLayer.value#64178
                common_propsObject.Color = colorCavitat

                common_propsObject2 = AllplanBaseElements.CommonProperties()
                common_propsObject2.Layer = KN_XPS_RECESS#KN_XPS_RECESS #56811#build_ele.BarraLayer.value#64178
                ...
                if build_ele.dadesENReftInterTD.value[posBarraRef].mostrarLiniaVertA:
                    ...
                    if len(str(build_ele.dadesENReftInterTD.value[posBarraRef].linia)) == 0:
                    ...
                    polyhedronCentral = create_polyline_interior(build_ele, punt_central, build_ele.dadesENReftInterTD.value[posBarraRef].Altura, llargada-2, True, pointUbi, int(linia), layer, posYdiferent= placement_mat[13])
                    if polyhedronCentral != []:
                        group_elems.append(polyhedronCentral[0])
                        group_elems_preview.append(polyhedronCentral[0])
                        group_elems.append(polyhedronCentral[3])
    ...
    try:
        ...
        for posBarraIncl in range(inici, final):#recorrer totes les Barres Inclinades
            ...
            if not inclinatPP.is_valid():
                #return[]
                inclinatPP = PP_EN_Premarc(random.random() * 3600,30 , 180, 850, 1.5,#DistanciaEntreTD, BarraAmple, BarraAltura,BarraLlargada, BarraGruix,
                                build_ele.IsUseGlobalProp.value, 17, 40120 # IsUseGlobalPropVert, FounColorVert, BarraLayerVert,
                                ) #EncaixosPar)
    ...
    #build_ele_ret = build_ele_antic
    #build_ele = build_ele_antic
...
def create_polyline_interior(build_ele, punt_central, llargadaX, llargadaZ, isHor, pointUbi, linia = 1, layer = "TD_FIXACIO", posYdiferent = 0):
    ...
    common_propsLinia.Layer = TD_FIXACIO#(TD_FIXACIO)
    if layer == "TD_NO_CARAGOLAR":
        common_propsLinia.Layer = TD_NO_CARAGOLAR#(TD_NO_CARAGOLAR)
    if layer == "KN_ELECTRICITAT_REINFORCEMENT" or layer == "40073" or layer == 40073:
        common_propsLinia.Layer = KN_ELECTRICITAT_REINFORCEMENT#(KN_ELECTRICITAT_REINFORCEMENT)
    if layer == "KN_AIGUA_REINFORCEMENT" or layer == "40074"  or layer == 40074:
        common_propsLinia.Layer = KN_AIGUA_REINFORCEMENT#(KN_AIGUA_REINFORCEMENT)
    ...
    if (isHor):
        ...
        vectorPOS.SetValue(13, posYdiferent - 150)# + posY#+ build_ele.desplYI.value )
        vectorPOS.SetValue(14, posZ )

        vectorPOSInv = AllplanGeo.Matrix3D()
        vectorPOSInv.SetValue(12, posX )#+ build_ele.desplXI.value )
        vectorPOSInv.SetValue(13, posYdiferent + 150 + 60)# + posY#+ build_ele.desplYI.value )
        ...
        vectorPOS.SetValue(13, posYdiferent - 150)# + posY
        vectorPOS.SetValue(14, posZ )

        vectorPOSInv = AllplanGeo.Matrix3D()
        vectorPOSInv.SetValue(12, posX )
        vectorPOSInv.SetValue(13, posYdiferent + 150 + 60)# + posY
        vectorPOSInv.SetValue(14, posZ )
...
def set_layers(build_ele, i):

    build_ele.NomTD.value = "TD"+str(i).zfill(3)
    ...
    if i % 2 == 0:
        ...
        TD_FIXACIO                       = 40036
        TD_NO_CARAGOLAR                  = 40037
        #build_ele.SelectorLayerSup.value = "TD_FIXACIO"
        #build_ele.SelectorLayerInf.value = "TD_FIXACIO"
        #build_ele.SelectorLayerHor.value = "TD_FIXACIO"
        #build_ele.SelectorLayerRef.value = "TD_FIXACIO"
        build_ele.BarraLayerVert.value   = 40001 #"TD_FIXACIO"
        build_ele.BarraLayer.value       = 40001 #"TD_FIXACIO"
    else:
        KN_XPS_RECESS                    = 40089
        KN_XPS_CAVITAT                   = 40090
        KN_PLD_RECESS                    = 40091
        KN_ESPONJA                       = 40067
        KN_ELECTRICITAT_REINFORCEMENT    = 40073
        KN_AIGUA_REINFORCEMENT           = 40074
        TD_ESTRUCTURA                    = 40076
        TD_FIXACIO                       = 40099
        TD_NO_CARAGOLAR                  = 40100
        #build_ele.SelectorLayerSup.value = "TD_FIXACIO"
        #build_ele.SelectorLayerInf.value = "TD_FIXACIO"
        #build_ele.SelectorLayerHor.value = "TD_FIXACIO"
        #build_ele.SelectorLayerRef.value = "TD_FIXACIO"
        build_ele.BarraLayerVert.value   = 40076 #"TD_FIXACIO"
        build_ele.BarraLayer.value       = 40076 #"TD_FIXACIO"
...
def values_from_solid3D(build_ele, placement_mat, element_listIS, Pared, desplAbs = 0):
    ...
    if len(element_listIS) == 0:
        ...
        llistaPosicions = []
        pos = 0
        puntInferiorEsqTD = AllplanGeo.Point3D()
        iniciTD = True
        for element in Pared:
            ...
            for vert in llistaVertex:
                if iniciTD:
                    puntInferiorEsqTD = vert
                    iniciTD = False
                if vert.X <= puntInferiorEsqTD.X:
                    puntInferiorEsqTD.X = vert.X
                if vert.Z <= puntInferiorEsqTD.Z:
                    puntInferiorEsqTD.Z = vert.Z
        ...
        for element in element_listIS:
            ...
            tubsPerSolidAfegit.append(False)

        #set_dadesTDVertTD_to_true(build_ele)
        tubsAfegitsNous = []

        for posVert in range( 0, len(build_ele.dadesTDVertTD.value)):
            ...
            lenActual = len(build_ele.listDesplVerticalsTD.value)
            nSolid = 0
            for solid in solidsInteriors:
                if solid["Esq"] > puntInferiorEsqTD.X + desplAbs and \
                    solid["Esq"] < puntInferiorEsqTD.X + desplAbs + build_ele.BarraLlargadaTD.value and \
                    solid["Dre"] > puntInferiorEsqTD.X + desplAbs  and \
                    solid["Esq"] < puntInferiorEsqTD.X + desplAbs + build_ele.BarraLlargadaTD.value :
                    if posVert < lenActual:
                        if build_ele.listDesplVerticalsTD.value[posVert].desplXAbs + desplAbs > solid["Esq"] - puntInferiorEsqTD.X  and \
                                build_ele.listDesplVerticalsTD.value[posVert].desplXAbs + desplAbs < solid["Dre"] - puntInferiorEsqTD.X and \
                                    posVert not in tubsAfegitsNous:

                            #build_ele.dadesTDVertTD.value[posVert] = build_ele.dadesTDVertTD.value[posVert]._replace(MostrarTDVertical = False)
                            build_ele.dadesTDVertTD.value[posVert] = build_ele.dadesTDVertTD.value[posVert]._replace(esProvisional = True)
                            build_ele.dadesTDVertTD.value[posVert] = build_ele.dadesTDVertTD.value[posVert]._replace(esProvisionalAuto = True)
                            build_ele.dadesTDVertTD.value[posVert] = build_ele.dadesTDVertTD.value[posVert]._replace(EncaixSup = True)
                            build_ele.dadesTDVertTD.value[posVert] = build_ele.dadesTDVertTD.value[posVert]._replace(EncaixInf = True)

                            if not tubsPerSolidAfegit[nSolid]:
                                solid["tubInf"], solid["tubSup"], listVertNous = crear_tubs_per_solid(build_ele, solid, puntInferiorEsqTD, posVert, desplAbs)
                                tubsAfegitsNous += listVertNous
                                tubsPerSolidAfegit[nSolid] = True

                            if solid["tubInf"] != "TD Inferior":
                                build_ele.dadesTDVertTD.value[posVert] = build_ele.dadesTDVertTD.value[posVert]._replace(BarraSuperior = solid["tubInf"])
                                listVertNous = crear_tubs_provisionals_per_solid(build_ele, posVert, solid["tubInf"], solid["tubSup"])
                                tubsAfegitsNous += listVertNous
                            else:
                                build_ele.dadesTDVertTD.value[posVert] = build_ele.dadesTDVertTD.value[posVert]._replace(BarraSuperior = solid["tubSup"])

                            tubsAfegitsNous.append(posVert)
                nSolid += 1

            print("")


        build_ele.IntegerTDSelector.value += 1
        set_values(build_ele, build_ele.IntegerTDSelector.value)
        for posVert in range( 0, len(build_ele.dadesTDVertTD.value)-1):
            #if #build_ele.listDesplVerticalsTD.value[posVert].desplXAbs == build_ele.BarraLlargadaTD.value or \
            if build_ele.listDesplVerticalsTD.value[posVert].desplXAbs >= build_ele.BarraLlargadaTD.value - build_ele.dadesTDVertTD.value[0].BarraAmple and \
                posVert != 9:
                build_ele.dadesTDVertTD.value[posVert] = build_ele.dadesTDVertTD.value[posVert]._replace(MostrarTDVertical = False)
            if build_ele.listDesplVerticalsTD.value[posVert].desplXAbs == 0 and posVert != 0:
                build_ele.dadesTDVertTD.value[posVert] = build_ele.dadesTDVertTD.value[posVert]._replace(MostrarTDVertical = False)
...
def crear_tubs_per_solid(build_ele, solid, puntInferiorEsqTD, posVert, desplAbs):
    #for solid in solids:

    #build_ele.dadesTDVertTD.value[build_ele.IntegerTDSelector.value-1] = build_ele.dadesTDVertTD.value[build_ele.IntegerTDSelector.value-1]._replace(MostrarTDVertical = False)
    build_ele.IntegerTDSelector.value += 1
    posVertEsq = len(build_ele.dadesTDVertTD.value)
    set_values(build_ele, build_ele.IntegerTDSelector.value)
    #set_values(build_ele, posVertEsq)
    build_ele.IntegerTDSelector.value += 1
    posVertDre = len(build_ele.dadesTDVertTD.value)
    set_values(build_ele, build_ele.IntegerTDSelector.value)
    #set_values(build_ele, posVertEsq)
    trobatEsq = False
    trobatDre = False

    for pos in range(posVert, len(build_ele.dadesTDVertTD.value)):
        #if build_ele.dadesTDVertTD.value[pos].MostrarTDVertical == False and trobatEsq and not trobatDre:
        if build_ele.listDesplVerticalsTD.value[pos].desplXAbs > build_ele.BarraLlargadaTD.value and trobatEsq and not trobatDre:
            posVertDre = pos
            trobatDre = True
        if build_ele.listDesplVerticalsTD.value[pos].desplXAbs > build_ele.BarraLlargadaTD.value and not trobatEsq and not trobatDre:
            posVertEsq = pos
            trobatEsq = True

    #crear esquerra
    #set_values(build_ele, posVertEsq)
    build_ele.dadesTDVertTD.value[posVertEsq] = build_ele.dadesTDVertTD.value[posVertEsq]._replace(MostrarTDVertical = True)
    build_ele.dadesTDVertTD.value[posVertEsq] = build_ele.dadesTDVertTD.value[posVertEsq]._replace(BarraAmple = 50)
    posEsq = solid["Esq"] - puntInferiorEsqTD.X - build_ele.dadesTDVertTD.value[posVertEsq].BarraAmple - 5
    print("posEsq: " + str(posEsq))
    build_ele.listDesplVerticalsTD.value[posVertEsq] = build_ele.listDesplVerticalsTD.value[posVertEsq]._replace(desplXAbs =  solid["Esq"] - puntInferiorEsqTD.X - desplAbs - build_ele.dadesTDVertTD.value[posVertEsq].BarraAmple - 5)

    #crear dreta
    #set_values(build_ele, posVertDre)
    build_ele.dadesTDVertTD.value[posVertDre] = build_ele.dadesTDVertTD.value[posVertDre]._replace(MostrarTDVertical = True)
    build_ele.listDesplVerticalsTD.value[posVertDre] = build_ele.listDesplVerticalsTD.value[posVertDre]._replace(desplXAbs = solid["Dre"] - puntInferiorEsqTD.X - desplAbs+  5)
    posDre = solid["Dre"] - puntInferiorEsqTD.X + 5
    print("posDre: " + str(posDre))


    posBarraHorSup = len(build_ele.BarresHorList.value)-2
    posBarraHorInf = len(build_ele.BarresHorList.value)-1
    trobatEsq = False
    trobatDre = False

    for pos in range(posVert, len(build_ele.BarresHorList.value)):
        if build_ele.BarresHorList.value[pos].BarraHor == False and trobatEsq and not trobatDre:
            posBarraHorInf = pos
            trobatDre = True
        if build_ele.BarresHorList.value[pos].BarraHor == False and not trobatEsq and not trobatDre:
            posBarraHorSup = pos
            trobatEsq = True


    if build_ele.listDesplVerticalsTD.value[posVertEsq].desplXAbs > build_ele.listDesplVerticalsTD.value[posVertDre].desplXAbs:
        aux = posVertEsq
        posVertEsq = posVertDre
        posVertDre = aux


    print("Vert Esq: " + str(posVertEsq) + "---------[" + str(posBarraHorSup)+ "] ------" + str(posVertDre))


    #crear Superior
    #posBarraHor = len(build_ele.BarresHorList.value-1)
    set_values_barresHor(build_ele, posBarraHorSup)
    set_valors_hor_ini(build_ele, 0, posBarraHorSup)
    build_ele.BarresHorList.value[posBarraHorSup] = build_ele.BarresHorList.value[posBarraHorSup]._replace(BarraHor = True)
    build_ele.BarresHorList.value[posBarraHorSup] = build_ele.BarresHorList.value[posBarraHorSup]._replace(BarraInici = "Tub " + str(posVertEsq) )
    build_ele.BarresHorList.value[posBarraHorSup] = build_ele.BarresHorList.value[posBarraHorSup]._replace(BarraFinal = "Tub " + str(posVertDre) )
    build_ele.BarresHorList.value[posBarraHorSup] = build_ele.BarresHorList.value[posBarraHorSup]._replace(AutoLongitud = True )
    build_ele.BarresHorList.value[posBarraHorSup] = build_ele.BarresHorList.value[posBarraHorSup]._replace(Posicio = solid["Sup"] - puntInferiorEsqTD.Z )
    #build_ele.dadesTDHortInter.value[posBarraHor] = build_ele.dadesTDHortInter.value[posBarraHor]._replace(desplY = solid["Sup"] - puntInferiorEsqTD.Z)
    #build_ele.dadesTDHortInter.value[posBarraHor] = build_ele.dadesTDHortInter.value[posBarraHor]._replace(Posicio = solid["Sup"] - puntInferiorEsqTD.Z)
    posSup = solid["Sup"] - puntInferiorEsqTD.Z
    print("posSup: " + str(posSup))


    print("Vert Esq: " + str(posVertEsq) + "---------[" + str(posBarraHorInf)+ "] ------" + str(posVertDre))

    #crear inferior
    #posBarraHor = len(build_ele.BarresHorList.value)
    if solid["Inf"] - puntInferiorEsqTD.Z > 50:
        set_values_barresHor(build_ele, posBarraHorInf)
        set_valors_hor_ini(build_ele, 0, posBarraHorInf)
        build_ele.BarresHorList.value[posBarraHorInf] = build_ele.BarresHorList.value[posBarraHorInf]._replace(BarraHor = True)
        build_ele.BarresHorList.value[posBarraHorInf] = build_ele.BarresHorList.value[posBarraHorInf]._replace(BarraInici = "Tub " + str(posVertEsq) )
        build_ele.BarresHorList.value[posBarraHorInf] = build_ele.BarresHorList.value[posBarraHorInf]._replace(BarraFinal = "Tub " + str(posVertDre) )
        build_ele.BarresHorList.value[posBarraHorInf] = build_ele.BarresHorList.value[posBarraHorInf]._replace(AutoLongitud = True )
        build_ele.BarresHorList.value[posBarraHorInf] = build_ele.BarresHorList.value[posBarraHorInf]._replace(Posicio = solid["Inf"] - puntInferiorEsqTD.Z )
        #build_ele.dadesTDHortInter.value[posBarraHor] = build_ele.dadesTDHortInter.value[posBarraHor]._replace(desplY = solid["Inf"] - puntInferiorEsqTD.Z)
        #build_ele.dadesTDHortInter.value[posBarraHor] = build_ele.dadesTDHortInter.value[posBarraHor]._replace(Posicio = solid["Sup"] - puntInferiorEsqTD.Z)
        posInf = solid["Inf"] - puntInferiorEsqTD.Z
        print("posInf: " + str(posInf))

        posBarraHorInf = "Tub " + str(posBarraHorInf)
    else:
        posBarraHorInf = "TD Inferior"
    print()

    return posBarraHorInf, "Tub " + str(posBarraHorSup), [posVertEsq, posVertDre]
    ...
    #set_values_barresHor(build_ele, posBarraHor)
    #set_valors_hor_ini(build_ele, 0, posBarraHor)
    build_ele.BarresHorList.value[posBarraHor] = build_ele.BarresHorList.value[posBarraHor]._replace(BarraHor = True)
    build_ele.BarresHorList.value[posBarraHor] = build_ele.BarresHorList.value[posBarraHor]._replace(BarraInici = "Tub " + str(0) )
    build_ele.BarresHorList.value[posBarraHor] = build_ele.BarresHorList.value[posBarraHor]._replace(BarraFinal = "Tub " + str(9) )
    build_ele.BarresHorList.value[posBarraHor] = build_ele.BarresHorList.value[posBarraHor]._replace(AutoLongitud = True )
    build_ele.BarresHorList.value[posBarraHor] = build_ele.BarresHorList.value[posBarraHor]._replace(Posicio = 200 )
    #build_ele.dadesTDHortInter.value[posBarraHor] = build_ele.dadesTDHortInter.value[posBarraHor]._replace(desplY = solid["Inf"] - puntInferiorEsqTD.Z)
    #build_ele.dadesTDHortInter.value[posBarraHor] = build_ele.dadesTDHortInter.value[posBarraHor]._replace(Posicio = solid["Sup"] - puntInferiorEsqTD.Z)
    print()
    '''
...
def crear_tubs_provisionals_per_solid(build_ele, posVert, tubInf, tubSup):
    listVertNous = []
    #build_ele.dadesTDVertTD.value[build_ele.IntegerTDSelector.value-1] = build_ele.dadesTDVertTD.value[build_ele.IntegerTDSelector.value-1]._replace(MostrarTDVertical = False)
    build_ele.IntegerTDSelector.value += 2
    set_values(build_ele, build_ele.IntegerTDSelector.value)
    Afegits = 0
    for pos in range(posVert, len(build_ele.dadesTDVertTD.value)):
        if (build_ele.listDesplVerticalsTD.value[pos].desplXAbs > build_ele.BarraLlargadaTD.value or pos >= len(build_ele.dadesTDVertTD.value)-3 ) \
            and Afegits < 2 : #and build_ele.dadesTDVertTD.value[posVert].esProvisional == False:
            build_ele.listDesplVerticalsTD.value[pos] = build_ele.listDesplVerticalsTD.value[pos]._replace(desplXAbs = build_ele.listDesplVerticalsTD.value[posVert].desplXAbs )
            build_ele.dadesTDVertTD.value[pos] = build_ele.dadesTDVertTD.value[pos]._replace(esProvisional = True)
            build_ele.dadesTDVertTD.value[pos] = build_ele.dadesTDVertTD.value[pos]._replace(esProvisionalAuto = True)
            build_ele.dadesTDVertTD.value[pos] = build_ele.dadesTDVertTD.value[pos]._replace(EncaixSup = True)
            build_ele.dadesTDVertTD.value[pos] = build_ele.dadesTDVertTD.value[pos]._replace(EncaixInf = True)
            listVertNous.append(pos)

            if Afegits == 0:
                build_ele.dadesTDVertTD.value[pos] = build_ele.dadesTDVertTD.value[pos]._replace(BarraSuperior = tubSup)
                build_ele.dadesTDVertTD.value[pos] = build_ele.dadesTDVertTD.value[pos]._replace(BarraInferior = tubInf)
            elif Afegits == 1:
                build_ele.dadesTDVertTD.value[pos] = build_ele.dadesTDVertTD.value[pos]._replace(BarraSuperior = "TD Superior")
                build_ele.dadesTDVertTD.value[pos] = build_ele.dadesTDVertTD.value[pos]._replace(BarraInferior = tubSup)
...
def update_mat_nListVert(build_ele):
    ...
    bobDadesGlobal = TDCollectionDadesVert(MostrarTDVertical= True,
                                           BarraAmple = build_ele.BarraAmpleVert.value,
                                            ...
                                            esProvisionalAuto  = build_ele.esProvisionalAuto.value,
                                            esProvisionalAuto1 = build_ele.esProvisionalAuto1.value,
                                            esProvisionalAuto2 = build_ele.esProvisionalAuto2.value,
                                            esProvisionalAuto3 = build_ele.esProvisionalAuto3.value,
                                            esProvisionalAuto4 = build_ele.esProvisionalAuto4.value
                                            )
    while len(build_ele.dadesTDVertTD.value) <= i:
        ...
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto  = build_ele.esProvisionalAuto.value )
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto1 = build_ele.esProvisionalAuto1.value)
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto2 = build_ele.esProvisionalAuto2.value)
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto3 = build_ele.esProvisionalAuto3.value)
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto4 = build_ele.esProvisionalAuto4.value)


    #DesplaçamentsVerticals
    TDCollectionDesplVert = collections.namedtuple('namedtuple', 'desplX desplXAbs desplY desplYAbs mostrarLiniaVertA desplLinA mostrarLiniaVertB desplLinB Separator')
...
def guardar_valors_actuals(build_ele, i):
    ...
    for x in range(inici, inici+final):
        ...
        if build_ele.ForatsVertListToShow.value != [] and build_ele.ForatsVertListToShow.value[0] != None and len(build_ele.ForatsVertListToShow.value) > y:
...
def mostrar_valors_actuals(build_ele, i):
    ...
    for x in range(inici, inici+final):
        if len(build_ele.ForatsVertList.value) <= x:
            TDCollection = collections.namedtuple('StirrupList', 'Forat orientacio Posicio Llargada Amplada Complet LlargadaB AmpladaB MostrarBox ProfunditatTFF Separator')
    ...
    for x in range(inici, inici+final):
        if len(build_ele.ColisVertList.value) <= x:
            TDCollection = collections.namedtuple('StirrupList', 'Colis orientacio Posicio Llargada Amplada MostrarBox Separator')
...
def set_values(build_ele, i):
    ...
    #DesplaçamentsVerticals
    TDCollectionDesplVert = collections.namedtuple('namedtuple', 'desplX desplXAbs desplY desplYAbs mostrarLiniaVertA desplLinA mostrarLiniaVertB desplLinB Separator')
    bobDespl = TDCollectionDesplVert(desplX = i * 700,
                                     desplXAbs = i * 700,
                                    desplY = 0,
                                    desplYAbs = 0,
    ...
    while len(build_ele.listDesplVerticalsTD.value) <= i:
        ...
        build_ele.listDesplVerticalsTD.value[i] = build_ele.listDesplVerticalsTD.value[i]._replace(desplX = i * 700)
        build_ele.listDesplVerticalsTD.value[i] = build_ele.listDesplVerticalsTD.value[i]._replace(desplY = 0)
        build_ele.listDesplVerticalsTD.value[i] = build_ele.listDesplVerticalsTD.value[i]._replace(desplXAbs = i * 700 )
        ...
        build_ele.listDesplVerticalsTD.value[i] = build_ele.listDesplVerticalsTD.value[i]._replace(mostrarLiniaVertB = False)
    ...
    while len(build_ele.listDesplVerticalsInteriors.value) <= i:
        ...
        build_ele.listDesplVerticalsInteriors.value[i] = build_ele.listDesplVerticalsInteriors.value[i]._replace(desplX = i * 700)
    ...
    bobDadesGlobal = TDCollectionDadesVert(MostrarTDVertical = True,
                                            ...
                                            vermell = False,
                                            FounColor = 23,
                                            esProvisionalAuto  = True,
                                            esProvisionalAuto1 = False,
                                            esProvisionalAuto2 = False,
                                            esProvisionalAuto3 = False,
                                            esProvisionalAuto4 = False)
    while len(build_ele.dadesTDVertTD.value) <= i:
        #build_ele.dadesTDVertTD.value[len(build_ele.dadesTDVertTD.value)-1] = build_ele.dadesTDVertTD.value[len(build_ele.dadesTDVertTD.value)-1]._replace(MostrarTDVertical = False)
        build_ele.dadesTDVertTD.value.append(bobDadesGlobal)
    else:
        ...
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(BarraAltura = 60)
        ...
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(linia = "Tipus 1")
        ...
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto  = True )
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto1 = False)
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto2 = False)
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto3 = False)
        build_ele.dadesTDVertTD.value[i] = build_ele.dadesTDVertTD.value[i]._replace(esProvisionalAuto4 = False)

def set_values_BarresVertListToShow(build_ele, i):
    if len(build_ele.BarresVertListToShow.value) <= i:
        TDCollection = collections.namedtuple('StirrupList', 'BarraVert Posicio PosicioAbs PosicioZ AutoLongitud Longitud BarraInici EditFront Edit EncaixInf EncaixSup acabatEditar editiantFrontals PestanyaSup PestanyaInf FemellaSup FemellaInf  linia layer vermell Separator')
        bob = TDCollection( BarraVert = False,
                            Posicio = 400.,
                            PosicioAbs = 0,
                            PosicioZ = 0,
...
def set_values_barresHor(build_ele, i):
    ...
    if len(build_ele.BarresHorList.value) <= i:
        for x in range(len(build_ele.BarresHorList.value), i+1):
            ...
            cont += 1
            pos += 400
            TDCollection = collections.namedtuple('StirrupList', 'BarraHor Orientacio Posicio AutoLongitud Longitud BarraInici BarraFinal Edit acabatEditar MostrarRecess MostrarCavitat Xapa ProfunditatXapa Layer Separator')
            bob = TDCollection( BarraHor = False,
                                Orientacio = 'Sup',
                                acabatEditar = False,
                                Posicio = pos,
...
def set_valors_hor_femelles(build_ele, nBarraVert):
    ...
    while (nBarraVert+2 + 2) * NombreBarresVertInt + 5 >= len(build_ele.FemellesHorIntAux.value):
        TDHorCollection = collections.namedtuple('StirrupList', 'Femella FemellaOr PosFemellaX PosFemellaY Separacio_forat_femella PosFemellaXOri Separator')
...
def set_valors_hor_ini(build_ele, nBarraVert, nHor):
    ...
    while nHor * 3 + 3 >= len(build_ele.ColisHorInt.value):
        if len(build_ele.ColisVertListToShow.value) == 0:
            TDHorCollection = collections.namedtuple('StirrupList', 'Colis orientacio Posicio Llargada Amplada MostrarBox Separator')
            bob = TDHorCollection(Colis = False,
                                  orientacio = "Sup",
                                  Posicio = 400,
                                  Llargada = 150,
                                  Amplada = 12,
    ...
    while nHor * 3 + 3 >= len(build_ele.PotesHorInt.value):
        if len(build_ele.PotesVertListToShow.value) == 0:
            TDHorCollection = collections.namedtuple('StirrupList', 'Pota Posicio Separator')
            bob = TDHorCollection(Pota = False,
                                  Posicio = 400,
                                  Separator = '')
            build_ele.PotesVertListToShow.value.append(bob)
        build_ele.PotesHorInt.value.append(build_ele.PotesVertListToShow.value[0])
    ...
    while nHor * 10 + 10 >= len(build_ele.ForatsHorInt.value):
        if len(build_ele.ForatsHorListToShow.value) == 0:
            TDHorCollection = collections.namedtuple('StirrupList', 'Forat orientacio Posicio Llargada Amplada Complet LlargadaB AmpladaB MostrarBox ProfunditatTFF Separator')
            bob = TDHorCollection(Forat = False,
                                  orientacio = "Sup",
                                  Posicio = 200,
                                  Llargada = 10,
                                  Amplada = 10,
                                  ...
                                  ProfunditatTFF = 15,
                                  Separator = '')
            build_ele.ForatsHorListToShow.value.append(bob)
    ...
    while nHor * 3 + 3 >= len(build_ele.FemellesHorInt.value):
        if len(build_ele.FemellesVertListToShow.value) == 0:
            TDHorCollection = collections.namedtuple('StirrupList', 'Femella FemellaOr PosFemellaX PosFemellaY Separacio_forat_femella PosFemellaXOri Separator')
            bob = TDHorCollection(Femella = False,
                                  FemellaOr = "Esq",
                                  PosFemellaX = 400,
    ...
    while nHor * 3 + 3 >= len(build_ele.EncaixHorInt.value):
        if len(build_ele.EncaixVertListToShow.value) == 0:
            TDHorCollection = collections.namedtuple('StirrupList', 'Encaix EncaixOr Longitud Amplitud Posicio Profunditat Pestanya Separator')
            bob = TDHorCollection(Encaix = False,
                                  EncaixOr= "Esq",
                                  Longitud = 30,
                                  Amplitud= 30,
                                  Posicio=400,
...
def set_valors_Adjacents(build_ele, nBarraAdj):
    ...
    while nBarraAdj >= len(build_ele.BarresAdjList.value):
        TDVertCollection = collections.namedtuple('StirrupList', 'BarraAdj Orientacio Posicio Longitud Profunditat Edit acabatEditar Separator')
...
def set_valors_Frontals(build_ele, nBarraFront):
    ...
    while nBarraFront >= len(build_ele.BarresFrontList.value):
        TDVertCollection = collections.namedtuple('StirrupList', 'BarraFront Amplitud Altura Orientacio Posicio Longitud Profunditat Edit Save acabatEditar Separator')
...
def createPolylineCancam(build_ele, altura, firstCancam, secondCancam, primerCilimdre, segonCilindre):
    ...
    common_propsLinia.Layer = TD_ESTRUCTURA#(TD_Estructura)
...
def createColisCavitatHorSup(build_ele, altura, i):
    ...
    common_propsObject = AllplanBaseElements.CommonProperties()
    common_propsObject.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)
    common_propsObject.Color = 31 #blanc

    common_propsObject2 = AllplanBaseElements.CommonProperties()
    common_propsObject2.Layer = KN_XPS_CAVITAT#(KN_XPS_CAVITAT)
    common_propsObject2.Color = 31 #blanc

    common_propsObjectEsp = AllplanBaseElements.CommonProperties()
    common_propsObjectEsp.Layer = KN_ESPONJA#(KN_ESPONJA)
...
def createColisCavitatHorInf(build_ele, altura, i):
    ...
    common_propsObject = AllplanBaseElements.CommonProperties()
    common_propsObject.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)#56811#build_ele.BarraLayer.value#64178
    common_propsObject.Color = 31 #blanc
...
def createBoxForatCavitat(build_ele, i, forats, nForat):
    common_propsObject = AllplanBaseElements.CommonProperties()
    #common_propsObject.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)#56811#build_ele.BarraLayer.value#64178
    common_propsObject.Layer = KN_ESPONJA#(KN_ESPONJA)#56811#build_ele.BarraLayer.value#64178
    common_propsObject.Color = 31 #blanc
...
def createBoxForatCavitatXPS(build_ele, i, forats, nForat):
    ...
    #common_props_Cilindre.Layer = KN_XPS_RECESS#(KN_XPS_RECESS)#56811#build_ele.BarraLayer.value#64178
    common_props_Cilindre.Layer = KN_PLD_RECESS#(KN_PLD_RECESS)
    common_props_Cilindre.Color = colorCavitat

    common_props_Cilindre2 = AllplanBaseElements.CommonProperties()
    common_props_Cilindre2.Layer = KN_XPS_CAVITAT#(KN_XPS_CAVITAT)
...
def crear_barres_inferiors_multiples(build_ele, doc, nBarraInf, mostrarActual, placement_mat):
    ...
    if build_ele.SelectorTDHInf.value == "Tub":
        horitzontalPP = PP_TD_Horitzontal(random.random() * 3600,build_ele.DistanciaEntreTD.value, build_ele.BarraAmpleInf.value, build_ele.BarraAlturaInf.value, llargadaInf, build_ele.BarraGruixInf.value,#DistanciaEntreTD, BarraAmple, BarraAltura,BarraLlargada, BarraGruix,
                                build_ele.IsUseGlobalProp.value, build_ele.FounColorInf.value, TD_ESTRUCTURA,# IsUseGlobalPropVert, FounColorVert, BarraLayerVert,
                                build_ele.ColisParINF.value, build_ele.PotaParINF.value, build_ele.ForatsParINF.value, #ColisPar, PotaPar, #matrius
                                build_ele.Ample_forat_femellaINF.value, build_ele.Altura_forat_femellaINF.value, build_ele.Separacio_forat_femellaINF.value,#Ample_forat_femella, Altura_forat_femella, Separacio_forat_femella,
        ...
        horitzontalPP = PP_TD_Horitzontal_Inf( random.random() * 3600, build_ele.BarraAmpleInf.value, build_ele.BarraAlturaInf.value, llargadaInf, build_ele.BarraGruixInf.value, build_ele.InvertirTDHoritzontalInf.value, build_ele.InvertirTDHoritzontalInf2.value,
                    [],
                    build_ele.IsUseGlobalProp.value, build_ele.FounColorInf.value, TD_ESTRUCTURA,
                    retallInici=desplXSeparat)
    ...
    if build_ele.MostrarTDHoritzontalInf.value:
        ...
        common_propsObject.Layer = KN_XPS_RECESS#build_ele.BarraLayer.value#64178
        common_propsObject.Color = 31 #blanc

        common_propsObject2 = AllplanBaseElements.CommonProperties()
        #common_propsObject.Layer = 56811#build_ele.BarraLayer.value#64178
        common_propsObject2.Layer = KN_XPS_CAVITAT#build_ele.BarraLayer.value#64178
        common_propsObject2.Color = 31 #blanc
        ...
        if build_ele.SepararTDHoritzontalInf.value:
            if build_ele.listDesplHoritzontalsInf.value[nBarraInf].mostrarLiniaA:
                ...
                polyhedronCentral = create_polyline_interior(build_ele, punt_central,build_ele.BarraAmpleInf.value,build_ele.listDesplHoritzontalsInf.value[nBarraInf].BarraLlargadaInf, True, pointUbi, int(linia), layer, posYdiferent= placement_mat[13])
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
                    group_elems.append(polyhedronCentral[3])
                    model_ele_list.append(AllplanBasisElements.ModelElement3D(polyhedronCentral[1], polyhedronCentral[2]))
    ...
    if build_ele.MostrarTDHoritzontalSup.value:
        ...
        if build_ele.SepararTDHoritzontalSup.value:
            if build_ele.listDesplHoritzontalsSup.value[nBarraSup].mostrarLiniaA:
                ...
                linia = build_ele.SelectorLiniaSup.value[len(build_ele.SelectorLiniaSup.value)-1]
                polyhedronCentral = create_polyline_interior(build_ele, punt_central,build_ele.listDesplHoritzontalsSup.value[nBarraSup].BarraAmpleSup,build_ele.listDesplHoritzontalsSup.value[nBarraSup].BarraLlargadaSup, True, pointUbi, int(linia), build_ele.SelectorLayerSup.value, posYdiferent= placement_mat[13])
                if polyhedronCentral != []:
                    group_elems.append(polyhedronCentral[0])
                    group_elems_preview.append(polyhedronCentral[0])
                    group_elems.append(polyhedronCentral[3])
...
def copiar_valors_Vert(build_ele,nVer):
    ...
    for nVerA in  range(nVer*10, nVer*10+10 ):
        if a >= len(build_ele.ForatsVertListCopy.value) :
            ForatsCopyDadesCollection = collections.namedtuple('StirrupList', 'Forat orientacio Posicio Llargada Amplada Complet LlargadaB AmpladaB MostrarBox ProfunditatTFF Separator')
...
def create_num_on_view(build_ele, j, vectorH1):
    ...
    num_provisionals_views_object = [View2D3D ([AllplanBasisElements.ModelElement3D(common_props_Lprovisionals, Lprovisionals_BrepObject)])]
    ...
    test = PythonPart ("TD_CreateText", parameter_list = numVert.get_params_list(),
                                ...
                                views = num_provisionals_views_object, matrix = vectorH1B, common_props = common_props_Lprovisionals, attribute_list = attr_list_Lprovisionals)
...
def set_dadesTDVertTD_to_true(build_ele):
    for elem in range(0, len(build_ele.dadesTDVertTD.value)):
        build_ele.dadesTDVertTD.value[elem] =  build_ele.dadesTDVertTD.value[elem]._replace(MostrarTDVertical = True)
...
class TD_Conjunt_8():
    ...
    def __init__(self, build_ele : BuildingElement, doc, placement_mat = AllplanGeo.Matrix3D(), element_listTD = [], Pared = [], BarraLlargada = -1.0, TDAlcada = -1.0, numID = 1 ):
        ...
        self.element_listTD = element_listTD
        self.TDLlargada = BarraLlargada
        self.TDAlcada = TDAlcada
        self.Pared = Pared
    ...
    def filename(self):
        return "TD_Conjunt_8_clase_PPTD_Solids.py"
    ...
    def create_estructura(self, build_ele):
        ...
        self.result = create_element_class(build_ele , doc, self.placement_mat, self.element_listTD, self.Pared, self.TDLlargada, self.TDAlcada, self.numID)
        #model_elem_list = result["elements"]
        #handle_list = result["handles"]
        #model_elem_list_preview = result["preview_elements"]
        #group_elems = result["group_elems"]
    ...
    def create(self):
        ...
        self.result = create_element_class(self.build_ele_TD , self.doc_TD, self.placement_mat, self.element_listTD, self.Pared, self.TDLlargada, self.TDAlcada, self.numID)
        #model_elem_list = result["elements"]
        #handle_list = result["handles"]
        #model_elem_list_preview = result["preview_elements"]
        #group_elems = result["group_elems"]
    ...
    def set_values_tubs_true(self):
        set_dadesTDVertTD_to_true(self.build_ele_TD)
        return True
    ...
    def values_from_solid3D(self, desplAbs, build_ele):
        values_from_solid3D(build_ele, self.placement_mat, self.element_listTD, self.Pared, desplAbs)
