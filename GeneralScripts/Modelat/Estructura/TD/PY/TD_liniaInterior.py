...
def create_element(build_ele, doc):
    ...
    TDHoritzontal = LiniaInterior(build_ele.zUnique.value, build_ele.BarraLlargada.value, build_ele.isHor.value) #matriu
...
class LiniaInterior():
    ...
    def __repr__(self):
        return 'TD_Horitzontal(zUnique=%s, BarraLlargada=%s, isHor=%s)\n' \
