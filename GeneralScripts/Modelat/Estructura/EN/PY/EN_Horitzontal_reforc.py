...
print('Load EN_Horitzontal_reforc.py')
...
def create_element(build_ele, doc):
    ...
    TDHoritzontal = PP_EN_Horitzontal_reforc(build_ele.zUnique.value, build_ele.BarraAmple.value, build_ele.BarraAltura.value, build_ele.BarraLlargada.value, build_ele.BarraGruix.value, build_ele.invertirPeca.value,
    ...
    pythonpart = PythonPart ("PP_EN_Horitzontal_reforc",
...
class PP_EN_Horitzontal_reforc():
    """
    ...
    def create_barra(self):
        ...
        elif self.invertirPeca == "Sup":
            vector = AllplanGeo.Vector3D(self.BarraGruix, 0, 0)
            geometry2 = AllplanGeo.Move(geometry2, vector)
            geometry = AllplanGeo.MakeBoolean(geometry1, geometry2)
        elif self.invertirPeca == "Esq":
            geometry2 = AllplanGeo.Polyhedron3D.CreateCuboid(self.BarraLlargada - self.BarraGruix*2,
