...
print('Load EN_Horitzontal_PP.py')
...
def create_element(build_ele, doc):
    ...
    TDHoritzontal = PP_EN_Horitzontal(build_ele.zUnique.value, build_ele.DistanciaEntreTD.value, build_ele.BarraAmple.value, build_ele.BarraAltura.value, build_ele.BarraLlargada.value, build_ele.BarraGruix.value,
    ...
    pythonpart = PythonPart ("PP_EN_Horitzontal",
...
class PP_EN_Horitzontal():
    ...
    def __init__(self, zUnique, DistanciaEntreTD, BarraAmple, BarraAltura, BarraLlargada, BarraGruix,
                    ...
                    EncaixosPar, invertirPestanyes = False, retallInici = 0, llargBarraAmbRetallFinal = 0):
        """ initialize
    ...
    def create_femelles(self, nFemella):
        ...
        if PosFemellaX >= self.retallInici -1 and (PosFemellaX < self.retallInici + self.llargBarraAmbRetallFinal or self.llargBarraAmbRetallFinal == 0):
            ...
            if FemellesInv:
                femella_1 = AllplanGeo.Polyhedron3D.CreateCuboid(ample_forat_fem + 0.5,self.Altura_forat_femella ,3.1)
