...
print('Load EN_Horitzontal_Front.py')
...
def create_element(build_ele, doc):
    ...
    TDHoritzontal = EN_Horitzontal_Front(build_ele.DistanciaEntreTD.value, build_ele.BarraAmple.value, build_ele.BarraAltura.value, build_ele.BarraLlargada.value, build_ele.BarraGruix.value,
