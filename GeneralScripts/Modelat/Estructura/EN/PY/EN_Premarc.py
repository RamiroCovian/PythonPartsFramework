...
def create_element(build_ele, doc):
    ...
    TDHoritzontal = PP_EN_Premarc(build_ele.zUnique.value, build_ele.BarraAmple.value, build_ele.BarraAltura.value, build_ele.BarraLlargada.value, build_ele.BarraGruix.value,
    ...
    pythonpart = PythonPart ("PP_EN_Premarc",
...
class PP_EN_Premarc():
    ...
    def create(self):
        ...
        barraVert2 = self.create_barra(self.BarraAmple)
    ...
    def create_barra_vert(self):
        ...
        '''
        #creació cuboid exterior
        geometry1 = AllplanGeo.Polyhedron3D.CreateCuboid( 40, self.BarraAmple, self.BarraAltura )
        #crear cuboid interior
        geometry = geometry1
