...
<Element>
    <Script>
        <Name>Modelat\Estructura\EN\PY\EN_Conjunt_8_clase_PPEN.py</Name>
    ...
    <Page>
        ...
        <Parameter>
            ...
            <ValueType>StringComboBox</ValueType>
            <Visible>SelectorPPEN == 3 and TipusPorta == 'Corredissa'</Visible>
            <Persistent>Model</Persistent>
        </Parameter>
        ...
        <Parameter>
            ...
            <ValueType>StringComboBox</ValueType>
            <Visible>SelectorPPEN == 3 and TipusPorta == 'Corredissa' and VerticalAutoBalcCorred == False</Visible>
            <Persistent>Model</Persistent>
        </Parameter>
        <Parameter>
        ...
        <Parameter>
            ...
            <ValueList>[str(value) for value in valueListBarresComboBox]</ValueList>
            <ValueType>StringComboBox</ValueType>
            <Visible>SelectorPPEN == 3 and VerticalAutoBalc == False</Visible>
            <Persistent>Model</Persistent>
        </Parameter>
    ...
    <Page>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <MinValue>,,0</MinValue>
                <Visible>True, ForatsVertListToShowEN[$list_row][0] == True, ForatsVertListToShowEN[$list_row][0] == True, ForatsVertListToShowEN[$list_row][0] == True, ForatsVertListToShowEN[$list_row][0] == True, ForatsVertListToShowEN[$list_row][0] == True,ForatsVertListToShowEN[$list_row][0] == True and ForatsVertListToShowEN[$list_row][5] == True,ForatsVertListToShowEN[$list_row][0] == True and ForatsVertListToShowEN[$list_row][5] == True, False,True</Visible><!-- ,False-->
                <Persistent>Model</Persistent>
            </Parameter>
        </Parameter>
    </Page>
