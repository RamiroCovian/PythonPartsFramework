...
def create_element_class(build_ele, doc):
    ...
    if build_ele.SelectorPP.value == 1 and build_ele.SelectorTDH.value == "Més Tubs...":
    ...
    if (build_ele.SelectorPP.value != 1 and build_ele.SelectorPPAnt.value == 1) or build_ele.SelectorTDH.value != "Més Tubs..." or nHorInt != build_ele.SelectorTDHTotalAnt.value:
        try:
    ...
    if build_ele.SelectorPP.value == 1 and build_ele.SelectorTDH.value == "TD Inferior":
        ...
        if len(build_ele.BarresHorList.value) > nHorInt:
            build_ele.BarresHorList.value[nHorInt] = build_ele.BarresHorList.value[nHorInt]._replace(Edit = False)
    elif build_ele.SelectorPP.value == 1 and build_ele.SelectorTDH.value == "Més Tubs...":
