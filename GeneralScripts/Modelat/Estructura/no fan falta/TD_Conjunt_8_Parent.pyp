...
<Element>
    <Script>
        <Name>PMP\jerarquia\TD_Conjunt_8_Parent.py</Name>
    ...
    <!--
    <Page>
        <Name>SelectorPythonPartTDTEST</Name>
        <Text>Selector Fill TEST</Text>
    ...
    <Page>
        ...
        <Parameter>
            <Name>Separator</Name>
            <ValueType>Separator</ValueType>
            <Visible>SelectorPP == 1 and esProvisional</Visible>
        </Parameter>
        ...
        <Parameter>
            <Name>Separator</Name>
            <ValueType>Separator</ValueType>
            <Visible>SelectorPP == 1 and not tipusTubAuto</Visible>
        </Parameter>
        ...
        <Parameter>
            ...
            <Value>True</Value>
            <ValueType>CheckBox</ValueType>
            <Visible>(RotarTub == True and SelectorPP == 1) or (RotarTub == False and SelectorPP == 1)</Visible>
            <Persistent>Model</Persistent>
        </Parameter>
        <Parameter>
            ...
            <ValueType>StringComboBox</ValueType>
            <Visible>RotarTub == True and SelectorPP == 1</Visible>
        ...
        <Parameter>
            ...
            <ValueType>StringComboBox</ValueType>
            <Visible>RotarTub == False and SelectorPP == 1</Visible>
            <BackgroundColor>(0, 255, 0)</BackgroundColor>
            <Persistent>Model</Persistent>
        </Parameter>
        <Parameter>
    ...
    <Page>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <value>True</value>
                <ValueType>Expander</ValueType>
                <Visible>IsUseGlobalProp == False and SelectorPP == 1</Visible>
