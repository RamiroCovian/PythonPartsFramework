...
def create_element(build_ele, doc):
    ...
    TDHoritzontal = PP_IS_tub(build_ele.zUnique.value, build_ele.DistanciaEntreTD.value, build_ele.BarraAmple.value, build_ele.BarraAltura.value, build_ele.BarraLlargada.value, build_ele.BarraGruix.value,
    ...
    pythonpart = PythonPart ("PP_IS_tub",
...
class PP_IS_tub():
    ...
    def create(self):
        ...
        ele1 = self.Barra #self.create_barra()
        if self.Barra.Is3DElement():
            ele1 = self.Barra.GetModelGeometry()
        else:
