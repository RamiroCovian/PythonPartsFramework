...
<Element>
    <Script>
        <Name>Modelat\Estructura\Conjunt_8_Parent_Script.py</Name>
    ...
    <Page>
        ...
        <Visible>SelectorPPPare == 2 and (SelectorPPTD == 1 or (SelectorPPTD == 2 or (SelectorPPTD == 1 and SelectorTDHTD == "Mes Tubs...")) or SelectorPPTD == 4)</Visible>
        <Persistent>Model</Persistent>
    ...
    <Page>
        <Name>CollisosPotes</Name>
        <Text>Collisos i Potes</Text>
        <Visible>(SelectorPPTD == 2 or (SelectorPPTD == 1 and SelectorTDHTD == "Mes Tubs...")) and SelectorPPPare == 2 </Visible>
        <Persistent>Model</Persistent>
    ...
    <Page>
        <Name>Forats</Name>
        <Text>Forats</Text>
        <Visible>(SelectorPPEN == 2 or (SelectorPPEN == 1 and SelectorENH == "Mes Tubs...") )and SelectorPPPare == 3</Visible>
        <Persistent>Model</Persistent>
