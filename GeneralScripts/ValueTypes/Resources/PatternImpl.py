""" implementation of the Pattern value type
"""
...
class PatternImpl(BaseIntImpl):
    """ implementation of the Pattern value type
    """

    @staticmethod
    def get_value(value_str: str) -> (list[int] | int):
        """ get the pattern from a string
        ...
        if value_str == GeneralConstants.USE_CURRENT_RESOURCE_VALUE:
            return AllplanSettings.AllplanGlobalSettings.GetCurrentPatternId()
