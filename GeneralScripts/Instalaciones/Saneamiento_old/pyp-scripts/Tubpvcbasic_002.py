# -*- coding: utf-8 -*-
"""Tubo PVC básico fijo (25 mm × 70 mm)"""
...
class TuboPVCBasico:
    ...
    def _add_user_attributes(self, attr_list):
        ...
        try:
            ...
            if attr_pmp_diametre_id and attr_pmp_diametre_id > 0:
                try:
                    attr_list.append(AllplanBaseElements.AttributeInt(attr_pmp_diametre_id, 25))
                except:
            ...
            print(f"[Tubpvcbasic_002] Advertencia al agregar atributos de usuario: {e}")
    ...
    def _add_copy_attributes(self, attr_list, idx):
        ...
        try:
            ...
            # No bloquear la creación si hay problemas con los atributos
            print(f"[Tubpvcbasic_002] Advertencia al agregar atributos a copia {idx}: {e}")


# ===== Punto de entrada estándar de PythonPart =====
def create_element(build_ele, _doc, rot_x=180.0, rot_y=0.0, rot_z=0.0) -> CreateElementResult:
    """Instancia la clase y delega la creación del elemento. Permite rotar sobre eje x, y, z."""
    return TuboPVCBasico(build_ele, _doc, rot_x, rot_y, rot_z).create_result()
