# -*- coding: utf-8 -*-
"""Codo rigido fecal 110mm 90/87 (L1000_D87, cambio de plano)."""
...
class CodoRigido110mF90:
    ...
    def _add_user_attributes_110mm_87(self, attr_list):
        ...
        try:
            ...
            print(
                f"[Colze_rigid_110m_f_90_script] Advertencia atributos 110mm 87°: {e}"
            )
...
def create_element(build_ele, _doc) -> CreateElementResult:
    return CodoRigido110mF90(build_ele, _doc).create_result()
...
class CodoRigido110mF90Script(BaseScriptObject):
    """PythonPart: codo rigido fecal Ø110 para 90°/87°."""
