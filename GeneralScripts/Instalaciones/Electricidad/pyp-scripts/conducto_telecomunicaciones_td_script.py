...
_COLOR_INNER = 15   # mismo que IS telecomunicaciones
...
def create_script_object(build_ele, script_object_data):
    return ConductoTelecomunicacionesTdScript(build_ele, script_object_data)


# --- Clase Principal del PythonPart ---
class ConductoTelecomunicacionesTdScript(BaseScriptObject):
    """PythonPart para conducto de Telecomunicaciones TD (corrugados, color negro)."""
    ...
    def get_attributes_custom(self, value: float = 0, tipo: str | None = None,
        ...
        try:
            ...
            print(f"[TelecosTD] Error en get_attributes_custom: {e}")
        return attr_list
