...
def create_preview(build_ele, script_object_data):
    ...
    model_ele_list = conducto_3D.create_conducto_geometry_3D(color=6)
    return model_ele_list, []


def create_script_object(build_ele, script_object_data):
    return ConductoCajetinAEnchufeScript(build_ele, script_object_data)


class ConductoCajetinAEnchufeScript(BaseScriptObject):
    """PythonPart para conducto Cajetín a enchufe (corrugados)."""
    ...
    def get_attributes_custom(self, value: float = 0, tipo: str | None = None,
        ...
        Atributos técnicos del conducto (Atributo personalizado):
          ...
          06 → Color del cable (nombre, p.ej. "Vermell")
        ...
        try:
            ...
            print(f"[CajetinEnchufe] Error en get_attributes_custom: {e}")
        return attr_list
