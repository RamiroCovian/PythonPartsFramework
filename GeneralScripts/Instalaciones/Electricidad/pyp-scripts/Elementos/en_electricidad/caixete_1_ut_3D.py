...
class Caixete1UTObject3D:
    """
    Caixete 1 UT – EN Electricitat.

    Idéntico al Caixeti 1 TD pero sin elementos duplicados en la misma posición.

    Composición:
      - Cuerpo trapezoidal × 1                     color 5
      - Cilindros pequeños 10mm × 1 (cada uno)     color 5
      - Cilindro mediano 35mm × 1                  color 5
    ...
    def _create_cilindros(self) -> ModelEleList:
        ...
        bases = [
            # Cilindro pequeño izquierdo — color 5
            {
                "type": "cylinder",
            ...
            # Cilindro pequeño derecho — color 5
            {
                "type": "cylinder",
                "radius": self.CYL_RADIUS * 2.0,
                "height": self.DEPTH,
            ...
            # Cilindro grande 34mm × 50mm — color 1
            {
                "type": "cylinder",
            ...
            # Cilindro trasero 34mm × 16mm — color 28
            {
                "type": "cylinder",
