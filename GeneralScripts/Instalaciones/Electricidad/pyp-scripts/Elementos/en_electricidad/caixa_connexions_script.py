...
from .caixa_connexions_3D import CaixaConnexionsObject3D
...
def create_preview(build_ele, script_object_data):
    ...
    obj = CaixaConnexionsObject3D()
    model_ele_list = obj.create_geometry_3d()
    return model_ele_list, []


def create_script_object(build_ele, script_object_data):
    return CaixaConnexionsScript(build_ele, script_object_data)


class CaixaConnexionsScript(BaseScriptObject):
    """Caixa connexions - EN Electricitat."""
