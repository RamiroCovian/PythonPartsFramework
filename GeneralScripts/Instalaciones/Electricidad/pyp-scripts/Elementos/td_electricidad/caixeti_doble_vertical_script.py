...
from .caixeti_doble_vertical_3D import CaixetiDobleVertical3D
...
def create_preview(build_ele, script_object_data):
    obj = CaixetiDobleVertical3D()
    model_ele_list = obj.create_geometry_3d()
    return model_ele_list, []


def create_script_object(build_ele, script_object_data):
    return CaixetiDobleVerticalScript(build_ele, script_object_data)


class CaixetiDobleVerticalScript(BaseScriptObject):
