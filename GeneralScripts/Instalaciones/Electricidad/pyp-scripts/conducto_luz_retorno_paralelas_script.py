...
def create_preview(build_ele, script_object_data):
    ...
    model_ele_list = conducto_3D.create_conducto_geometry_3D(color=128)
    return model_ele_list, []


def create_script_object(build_ele, script_object_data):
    return ConductoLuzRetornoParalelasScript(build_ele, script_object_data)


class ConductoLuzRetornoParalelasScript(BaseScriptObject):
    """PythonPart para conducto Luz retorno / Paralelas (corrugados)."""
    ...
    def get_attributes_custom(self, value: float = 0, tipo: str | None = None,
        ...
        Atributos técnicos del conducto (Atributo personalizado):
          ...
          06 → Color del cable (nombre, p.ej. "Marró")
