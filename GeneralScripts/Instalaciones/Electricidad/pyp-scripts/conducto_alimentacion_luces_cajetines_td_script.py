...
_COLOR_INNER = 16   # mismo que IS alimentación luces / cajetines
...
def create_script_object(build_ele, script_object_data):
    return ConductoAlimentacionLucesCajetinesTdScript(build_ele, script_object_data)


# --- Clase Principal del PythonPart ---
class ConductoAlimentacionLucesCajetinesTdScript(BaseScriptObject):
    """PythonPart para conducto Alimentación Luces / Cajetines TD (encapsulado XPS)."""
    ...
    def get_attributes_custom(self, value: float = 0, tipo: str | None = None,
        ...
        try:
            ...
            print(f"[AlimentacionLucesCajetinesTD] Error en get_attributes_custom: {e}")
        return attr_list
