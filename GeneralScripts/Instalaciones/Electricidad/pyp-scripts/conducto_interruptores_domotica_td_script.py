...
_COLOR_INNER = 27   # mismo que IS interruptores / domótica
...
def create_script_object(build_ele, script_object_data):
    return ConductoInterruptoresDomoticaTdScript(build_ele, script_object_data)


# --- Clase Principal del PythonPart ---
class ConductoInterruptoresDomoticaTdScript(BaseScriptObject):
    """PythonPart para conducto Interruptores / Domótica TD (encapsulado XPS)."""
    ...
    def get_attributes_user(self, diameter: float = 20.0, color: int = 0) -> list:
        ...
        try:
            ...
            user_attributes.append(AllplanBaseElements.AttributeString(attr_ids["pmp_CARTICULO"], "KN02_004_003"))
            ...
            user_attributes.append(AllplanBaseElements.AttributeString(attr_ids["pmp_tipus_cablejat"], "1,5N + 1,5M + 1,5G (2x)"))
    ...
    def get_attributes_custom(self, value: float = 0, tipo: str | None = None,
        ...
        try:
            ...
            print(f"[InterruptoresDomoticaTD] Error en get_attributes_custom: {e}")
        return attr_list
