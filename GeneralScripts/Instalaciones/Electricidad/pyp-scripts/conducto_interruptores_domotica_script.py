...
def create_preview(build_ele, script_object_data):
    ...
    model_ele_list = conducto_3D.create_conducto_geometry_3D(color=27)
    return model_ele_list, []


def create_script_object(build_ele, script_object_data):
    return ConductoInterruptoresDomoticaScript(build_ele, script_object_data)


class ConductoInterruptoresDomoticaScript(BaseScriptObject):
    """PythonPart para conducto Interruptores / Domótica (corrugados)."""
    ...
    def get_attributes_custom(self, value: float = 0, tipo: str | None = None,
        ...
        Atributos técnicos del conducto (Atributo personalizado):
          ...
          06 → Color del cable (nombre, p.ej. "Gris")
        ...
        try:
            ...
            print(f"[InterruptoresDomotica] Error en get_attributes_custom: {e}")
        return attr_list
