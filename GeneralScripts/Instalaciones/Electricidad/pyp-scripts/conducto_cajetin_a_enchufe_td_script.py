...
_COLOR_INNER = 6    # mismo que IS cajetín a enchufe
...
def create_script_object(build_ele, script_object_data):
    return ConductoCajetinAEnchufeTdScript(build_ele, script_object_data)


# --- Clase Principal del PythonPart ---
class ConductoCajetinAEnchufeTdScript(BaseScriptObject):
    """PythonPart para conducto Cajetín a Enchufe TD (encapsulado XPS)."""
    ...
    def get_attributes_user(self, diameter: float = 20.0, color: int = 0) -> list:
        ...
        try:
            ...
            user_attributes.append(AllplanBaseElements.AttributeString(attr_ids["pmp_CARTICULO"], "KN02_004_005"))
            ...
            user_attributes.append(AllplanBaseElements.AttributeString(attr_ids["pmp_tipus_cablejat"], "2,5N + 2,5B + 2,5TT"))
    ...
    def get_attributes_custom(self, value: float = 0, tipo: str | None = None,
        ...
        try:
            ...
            print(f"[CajetinAEnchufeTD] Error en get_attributes_custom: {e}")
        return attr_list
