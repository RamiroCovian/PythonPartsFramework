            ...
            if _inst_label:
                ...
                if _model:
                    ...
                    if isinstance(raw_diam, list):
                        ...
                        # Respetar la selección actual del usuario si es válida para este modelo;
                        # de lo contrario usar el primer valor de la lista.
                        if self.diameter_type not in raw_diam:
