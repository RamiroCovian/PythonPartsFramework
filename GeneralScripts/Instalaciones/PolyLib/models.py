...
class AdditionalParametersBase:
    ...
    # ── Desfase Z ──
    z_offset: bool = True                  # Double desfase Z (m) sumado al snap

    # ── Desplazamiento conjunto ──
    multi_drag: bool = True                # CheckBox desplazamiento conjunto de vértices
    ...
    attribute_codificacion: bool = False
    attribute_codificacion_apply: bool = False
    ...
    # ── Trazado Paralelo ──
    parallel_enabled:      bool = True   # CheckBox habilitar trazado paralelo
    parallel_distance:     bool = True   # Integer distancia entre tubos
    parallel_lado:         bool = True   # StringComboBox inside|outside
    parallel_multi_select: bool = True   # CheckBox selección múltiple de segmentos
    parallel_agregar:      bool = True   # Button agregar paralela

    # ── Acciones ──
    borrar_seccion: bool = True            # Button borrar segmento
    invertir_caval: bool = False
    ...
    def to_param_map(self) -> dict[str, bool]:
        ...
        return {
            ...
            ParamNames.DrawMode.Z_OFFSET:               self.z_offset,
            ParamNames.DrawMode.MULTI_DRAG:             self.multi_drag,
            ...
            ParamNames.Attributes.CODIFICACION:         self.attribute_codificacion,
            ParamNames.Attributes.CODIFICACION_APPLY:   self.attribute_codificacion_apply,
            ...
            ParamNames.Parallel.ENABLED:                self.parallel_enabled,
            ParamNames.Parallel.DISTANCE:               self.parallel_distance,
            ParamNames.Parallel.LADO:                   self.parallel_lado,
            ParamNames.Parallel.MULTI_SELECT:           self.parallel_multi_select,
            ParamNames.Parallel.AGREGAR:                self.parallel_agregar,
            ParamNames.Actions.BORRAR_SECCION:          self.borrar_seccion,
            ParamNames.Actions.INVERTIR_CAVAL:          self.invertir_caval,
...
class Electricidad(BaseInstallation):
    ...
    class Show(AdditionalParametersShow):
        ...
        poly_mode: bool = False
        attribute_codificacion: bool = True
        attribute_codificacion_apply: bool = True
