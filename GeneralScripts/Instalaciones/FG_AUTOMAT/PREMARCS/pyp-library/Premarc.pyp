    ...
    <Page>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <Text>Fondo</Text>
                <Value>295</Value>
                <ValueList>return "|".join(str(value) for value in valueListaGrosor) if isinstance(valueListaGrosor, list) else valueListaGrosor</ValueList>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <Value>Cerrado</Value>
                <ValueList>return "|".join(str(value) for value in valueListaAbiertoCerrado) if isinstance(valueListaAbiertoCerrado, list) else valueListaAbiertoCerrado</ValueList>
                <ValueType>StringComboBox</ValueType>
            </Parameter>
            ...
            <Parameter>
                ...
                <Value>False</Value>
                <ValueType>CheckBox</ValueType>
                <Visible>ComboBoxAbiertoCerrado != "TANCAT" and "+ REA" not in
                    ComboBoxAbiertoCerrado</Visible>
            </Parameter>
            ...
            <Parameter>
                ...
                <ValueType>StringComboBox</ValueType>
                <Visible>EnableREAEspecial and ComboBoxAbiertoCerrado != "TANCAT" and "+ REA" not in
                    ComboBoxAbiertoCerrado</Visible>
            </Parameter>
            ...
            <Parameter>
                ...
                <Value>40</Value>
                <ValueType>Double</ValueType>
                <Visible>EnableREAEspecial and ComboBoxAbiertoCerrado in ("OBERT PER DALT", "OBERT
                    PER DALT VARIANT", "OBERT PER BAIX", "OBERT PER BAIX VARIANT") and
                    ComboBoxREAEspecial == "REAs en C"</Visible>
            </Parameter>
            ...
            <Parameter>
                ...
                <Value>390</Value>
                <ValueType>Double</ValueType>
                <Visible>EnableREAEspecial and (ComboBoxREAEspecial == "REAs en L STD CORTA" or
                    ComboBoxREAEspecial == "REAs en L STD") and ComboBoxAbiertoCerrado in ("OBERT
                    PER DALT VARIANT", "OBERT PER BAIX VARIANT", "OBERT FEMELLA DRETA", "OBERT NO
                    FEMELLA DRETA", "SUP. FEMELLA / INF NO FEMELLA DRET.", "SUP. NO FEMELLA / INF.
                    FEMELLA DRET.", "OBERT FEMELLA ESQUERRA", "OBERT NO FEMELLA ESQUERRA", "SUP.
                    FEMELLA / INF NO FEMELLA ESQ.", "SUP. NO FEMELLA / INF. FEMELLA ESQ.")</Visible>
            </Parameter>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <ValueList>return "|".join(str(value) for value in valueListaPendiente) if isinstance(valueListaPendiente, list) else valueListaPendiente</ValueList>
                <ValueType>StringComboBox</ValueType>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <Text>Encajes</Text>
                <Value>Encajes</Value>
                <ValueList>return "|".join(str(value) for value in valueListaEncajes) if isinstance(valueListaEncajes, list) else valueListaEncajes</ValueList>
                <ValueType>StringComboBox</ValueType>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <ValueList>return "|".join(str(value) for value in valueListaPersianas) if isinstance(valueListaPersianas, list) else valueListaPersianas</ValueList>
                <ValueType>StringComboBox</ValueType>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <ValueList>return "|".join(str(value) for value in valueListaEscuadras) if isinstance(valueListaEscuadras, list) else valueListaEscuadras</ValueList>
                <ValueType>StringComboBox</ValueType>
            </Parameter>
        ...
        <Parameter>
            ...
            <Parameter>
                ...
                <Text>Tubos</Text>
                <Value>Tubos</Value>
                <ValueList>return "|".join(str(value) for value in valueListaTubos) if isinstance(valueListaTubos, list) else valueListaTubos</ValueList>
                <ValueType>StringComboBox</ValueType>
            </Parameter>
