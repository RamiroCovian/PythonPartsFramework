...
from .conexion_3D import ConexionObject3D
...
def create_script_object(build_ele, script_object_data):
    return ConexionScript(build_ele, script_object_data)


# --- Clase Principal del PythonPart ---
class ConexionScript(BaseScriptObject):
    ...
    def get_attributes_custom(self):
        ...
        try:
            ...
            custom_attributes.append(AllplanBaseElements.AttributeString(1083, "CONNEXIÓ Ø160"))  # Custom attribute 01
    ...
    def get_attributes_user(self):
        ...
        try:
            ...
            user_attributes.append(AllplanBaseElements.AttributeString(self.attr_pmp_carticul_id, "KN04_008_002"))
            ...
            user_attributes.append(AllplanBaseElements.AttributeDouble(self.attr_pmp_diametre_id, 160.0))
            ...
            user_attributes.append(AllplanBaseElements.AttributeString(self.attr_pmp_nom_id, "CONNEXIÓ Ø160"))
