...
<Element>
  <Script>
    <Name>PythonPartsTraining\ElementPoint.py</Name>
    <Title>Element Point</Title>
    <Version>1.0</Version>
  ...
  <Page>
    <Name>ElementPoint</Name>
    <Text>Indicar puntos por rol asociados a un elemento definido. Final crea y exporta.</Text>

    <!-- ===== SELECCIÓN DE ELEMENTO ===== -->
    <Parameter>
      <Name>ElementKey</Name>
      <Text>Elemento (clave)</Text>
      <Value>junction_box</Value>
    ...
    <!-- Símbolo opcional por click (usado por el marcador cuadrado) -->
    <Parameter>
