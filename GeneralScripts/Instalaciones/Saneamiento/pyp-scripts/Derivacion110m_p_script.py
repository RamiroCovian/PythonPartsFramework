# -*- coding: utf-8 -*-
"""Bifurcación en Y Ø110 mm red pluvial, derivación 45° (geometría D110 portada de DerivacioY_45_008)."""
...
class BifurcacionY110Pluvial110mm:
    """Modelo 3D TE 110-110-110 para instalación pluvial (tricapa_v / p_110)."""
    ...
    def _add_user_attributes_110mm(self, attr_list):
        ...
        try:
            ...
            print(f"[Derivacion110m_p_script] Atributos usuario 110mm pluvial: {e}")
...
def create_element(build_ele, _doc) -> CreateElementResult:
    return BifurcacionY110Pluvial110mm(build_ele, _doc).create_result()


class Derivacion110mPluvialScript(BaseScriptObject):
