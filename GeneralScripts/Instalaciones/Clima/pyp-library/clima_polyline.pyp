...
<Element>
    <Script>
        <Name>Instalaciones\Clima\pyp-scripts\clima_polyline.py</Name>
    ...
    <Page>
        ...
        <Parameter>
            ...
            <Parameter>
                <Name>RowReductorApply</Name>
                <Text>Reductor</Text>
                <ValueType>Row</ValueType>
                <Parameter>
                    <Name>ReductorApply</Name>
                    <Text>Aplicar reductor</Text>
                    <EventId>1039</EventId>
                    <Value>0</Value>
                    <ValueType>Button</ValueType>
                </Parameter>
                <Parameter>
                    <Name>ClimaReservedOpt100200300</Name>
                    <Text>Tramo recto reductor (mm)</Text>
                    <Value>300</Value>
                    <ValueList>100|200|300</ValueList>
                    <ValueType>StringComboBox</ValueType>
                </Parameter>
            </Parameter>
            <Parameter>
